...
DISCARD_FUN(void, vtan, (int32_t * restrict z,
                   const int16_t * restrict x,
                   int N))

#else

void vtan ( int32_t * restrict y,
      const int16_t * restrict x,
      int N )
{
    int n;
    static const int32_t tbl[2] = { 0x7fffffff, 0 };
    int32_t _7fffffff, inc;
    ...
    z0 = 0;
    z3 = BBE_MOVPINT16(16);
    _7fffffff = XT_L32I((int*)tbl, 0); inc = XT_L32I((int*)tbl, 4);
    ...
    for (n = 0; n < (N >> LOG2_BBE_SIMD_WIDTH); n++)
    {
        ...
        BBE_SVNX16_IP(y0, pY, 4 * BBE_SIMD_WIDTH);
    }
    ...
    for (n = 0; n < (N >> LOG2_BBE_SIMD_WIDTH); n++)
    {
        ...
        BBE_LVNX16_IP(y0, pZ, 4 * BBE_SIMD_WIDTH);
