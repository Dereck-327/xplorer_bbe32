...
int countones32 (int32_t x)
{
  ...
  x4 &= 15; x6 &= 15;
  x5 &= 15; x7 &= 15;
  z = tab[x0] + tab[x1] + tab[x2] + tab[x3] + tab[x4] + tab[x5] + tab[x6] + tab[x7];
  return z;
  */
  ...
  u6 = XT_AND(u6, 15);
  u7 = XT_AND(u7, 15);
  z0 = ((int32_t)countones_16b_tbl[u0] + countones_16b_tbl[u1] + countones_16b_tbl[u2] + countones_16b_tbl[u3] + countones_16b_tbl[u4] + countones_16b_tbl[u5] + countones_16b_tbl[u6] + countones_16b_tbl[u7]) & 63;
  return z0;
