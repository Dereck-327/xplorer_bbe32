...
void vlog10 ( int16_t * restrict y,
       ...
       int N )
{
    ...
    {
        z1 = BBE_MOVVA16(_9864);// lg2, Q15
        XT_MOVEQZ(_9864, _9864, _9864);
        BBE_LVNX16_IP(x0, pX, 4 * BBE_SIMD_WIDTH);
        ...
        {
            vsaN vsa22;
            vsa22 = BBE_ADDSAVSN(-22, nsa);
            xw = BBE_SLANX40(xw, vsa22);
            v0 = BBE_PACKLNX40(xw);
        }

        nsa = BBE_SUBSAVSN(24, nsa);
        e0 = BBE_MOVVVS(nsa);

        sel = BBE_MOVVSELNX16(v0, 12);//Q0 
        // ---- POLY.SU --- //
        v0 = BBE_POLYNX16_OFF(v0, 12, 0);//Q11

        p2 = BBE_SHFLNX16(t2, sel);//Q12
...
#else
DISCARD_FUN(void, vlog10, (int16_t * restrict y, const int32_t * restrict x, int N))
#endif
