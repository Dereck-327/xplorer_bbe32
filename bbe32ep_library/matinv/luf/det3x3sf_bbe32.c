...
#if 0
{
    ...
    const xb_vecN_4xcf32 * restrict pLU11=(const xb_vecN_4xcf32 *)(LU+(1+1*3)*L);
    const xb_vecN_4xcf32 * restrict pLU22=(const xb_vecN_4xcf32 *)(LU+(2+2*3)*L);
...
#else
{
    ...
    const xb_vecN_2xf32 * restrict pLU11=(const xb_vecN_2xf32 *)(LU+(1+1*3)*L);
    const xb_vecN_2xf32 * restrict pLU22=(const xb_vecN_2xf32 *)(LU+(2+2*3)*L);
    ...
    {
        xb_vecN_2xf32 d,a00,a11,a22;
        BBE_LVN_2XF32_XP(a00,pLU00,2*BBE_SIMD_WIDTH);
        BBE_LVN_2XF32_XP(a11,pLU11,2*BBE_SIMD_WIDTH);
        BBE_LVN_2XF32_XP(a22,pLU22,2*BBE_SIMD_WIDTH);
        d=BBE_MULN_2XF32(BBE_MULN_2XF32(a00,a11),a22);
        BBE_SVN_2XF32_IP(d,pD,2*BBE_SIMD_WIDTH);
    }
}
#endif
#else
DISCARD_FUN(void, det3x3sf, ( float32_t * restrict D, const float32_t * restrict LU, int L ))
#endif
