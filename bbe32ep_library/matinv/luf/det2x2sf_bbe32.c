...
#else
{
    ...
    const xb_vecN_2xf32 * restrict pLU11=(const xb_vecN_2xf32 *)(LU+3*L);
    ...
    {
        xb_vecN_2xf32 d,a00,a11;
        BBE_LVN_2XF32_IP(a00,pLU00,2*BBE_SIMD_WIDTH);
        BBE_LVN_2XF32_IP(a11,pLU11,2*BBE_SIMD_WIDTH);
        d=BBE_MULN_2XF32(a00,a11);
        BBE_SVN_2XF32_IP(d,pD,2*BBE_SIMD_WIDTH);
    }
}
#endif
#else
DISCARD_FUN(void, det2x2sf,( float32_t * restrict D, const float32_t * restrict LU, int L ))
#endif
