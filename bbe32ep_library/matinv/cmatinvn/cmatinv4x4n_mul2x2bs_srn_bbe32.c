                               ...
                               int L, int Ez )
{
  ...
  for ( l=0; l<L/8; l++ )
  {
    ...
    BBE_LAVNX16_XP( qY, QY_va, QY_rd, +8*2 );
    ...
    //--------------------------------------------------------------------------
    // Scale, round and pack 8 product matrices and store them to output array.
