                ...
                int SA, int M,int N, int N0, int L)
{
    ...
    xb_vecN_2xf32 Acc, Acc2, V0, R0, Z0, Z1;
    valign vR, vR1;
    ...
    for (l = 0; l < L; l++)
    {
        ...
        for (m = 0; m < M; m++)
        {
            ...
            pR = (const xb_vecN_2xf32 *)XT_ADDX4(N0 - 16, (uintptr_t)pR);
        }
        ...
        for (m = 0; m < M; m++)
        {
            ...
            BBE_LAN_2XF32_IP(Acc, vR, pR);
            BBE_MULSN_2XF32(Acc, Z1, V0);
            BBE_SAVN_2XF32_XP(Acc, vR1, pRw, (N - 8)*sizeof(float32_t));
