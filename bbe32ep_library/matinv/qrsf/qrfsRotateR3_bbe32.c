...
void qrfsRotateR3(float32_t* restrict R,const float32_t* restrict Fi,int M, int N,int L)
{
    ...
    pRr0 = (const xb_vecN_2xf32 *)(R + 3 * L);
    pRr1 = (const xb_vecN_2xf32 *)(R + 6 * L);
    pF = (const xb_vecN_2xf32 *)Fi;
    pF0 = (const xb_vecN_2xf32 *)(Fi + L);
    pF1 = (const xb_vecN_2xf32 *)(Fi + 2 * L);
    pR = (xb_vecN_2xf32 *)R;
    pR0 = (xb_vecN_2xf32 *)(R + 3 * L);
    pR1 = (xb_vecN_2xf32 *)(R + 6 * L);
    ...
    for (l = 0; l < L; l += (BBE_SIMD_WIDTH / 2))
    {
        ...
        R0 = BBE_LVN_2XF32_X(pRr1, L * sizeof(float32_t));
        Acc = BBE_MULN_2XF32(F0, R0);
        BBE_SVN_2XF32_X(Acc, pR1, L * sizeof(float32_t));
