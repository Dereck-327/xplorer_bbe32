...
void qrsfUpdateB4(float32_t* B,const float32_t* V,int L)
{
    ...
    xb_vecN_2xf32 Acc, Acc2, V0, V1, V2, V3, B0, B1, B2, B3, Z0;
    ...
    pBr0 = (const xb_vecN_2xf32 *)(B + L);
    pBr1 = (const xb_vecN_2xf32 *)(B + 2 * L);
    pBr2 = (const xb_vecN_2xf32 *)(B + 3 * L);
    pB = (xb_vecN_2xf32 *)B;
    pV = (const xb_vecN_2xf32 *)V;
    pV0 = (const xb_vecN_2xf32 *)(V + L);
    pV1 = (const xb_vecN_2xf32 *)(V + 2 * L);
    pV2 = (const xb_vecN_2xf32 *)(V + 3 * L);
    for (l = 0; l < L; l += (BBE_SIMD_WIDTH / 2))
    {
        BBE_LVN_2XF32_XP(V3, pV2, 0);
        BBE_LVN_2XF32_XP(B3, pBr2, 0);
        Acc = BBE_MULN_2XF32(V3, B3);
        BBE_LVN_2XF32_XP(V2, pV1, 0);
        BBE_LVN_2XF32_XP(B2, pBr1, 0);
        Acc2 = BBE_MULN_2XF32(V2, B2);
        ...
        BBE_MULSN_2XF32(B3, Z0, V3);
        BBE_SVN_2XF32_X(B3, pB, 3 * L * sizeof(float32_t));
