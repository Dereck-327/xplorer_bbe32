                        ...
                        int K,int M,int N, int L)
{
    ...
    xb_vecN_2xf32 Acc, Acc2, V0, V1, V2, V3, R0, R1, R2, R3, Z0;
    ...
    for (l = 0; l < (N - K)*L; l += (BBE_SIMD_WIDTH / 2))
    {
        ...
        BBE_MULSN_2XF32(R3, Z0, V3);
        BBE_SVN_2XF32_X(R3, pR, 3 * N*L * sizeof(float32_t));
        V2 = BBE_LVN_2XF32_X(pV, 2 * L * sizeof(float32_t));
        BBE_LVN_2XF32_IP(R2, pRr1, 2 * BBE_SIMD_WIDTH);
        BBE_MULSN_2XF32(R2, Z0, V2);
        BBE_SVN_2XF32_X(R2, pR, 2 * N*L * sizeof(float32_t));
        V1 = BBE_LVN_2XF32_X(pV, L * sizeof(float32_t));
        BBE_LVN_2XF32_IP(R1, pRr0, 2 * BBE_SIMD_WIDTH);
        BBE_MULSN_2XF32(R1, Z0, V1);
        BBE_SVN_2XF32_X(R1, pR, N*L * sizeof(float32_t));
