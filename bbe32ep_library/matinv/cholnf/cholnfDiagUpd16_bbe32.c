...
-------------------------------------------------*/
void cholnfDiagUpd16(float32_t* y,float32_t* D,const float32_t* Z,int N,int L,int SR,int SD)
{
    int l;
    ...
    valign vy;
    xb_vecN_2xf32 Acc, Acc1, Y0, rsqrt;
    xtfloat out;
