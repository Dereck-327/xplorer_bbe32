...
void cqrnfTakeColumn12(float32_t* restrict x,float32_t* restrict xt,const float32_t* restrict A,int M,int N,int SA,int L)
{
    ...
    if (M == 9)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t3, pA, (SA - 8 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 8 * 2 * L) * sizeof(float32_t));

            vTmp = BBE_MOVNX16_FROMN_4X64(t3);
            BBE_SAVNX16_XP(vTmp, vX, pX, 2 * (M - 2 * (BBE_SIMD_WIDTH / 4)) * sizeof(float32_t));
        }
    ...
    else if (M == 10)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t2, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t2, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 9 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 9 * 2 * L) * sizeof(float32_t));
    ...
    else if (M == 11)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t1, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t1, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 10 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 10 * 2 * L) * sizeof(float32_t));
    ...
    else if (M == 12)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t2, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t2, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 11 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 11 * 2 * L) * sizeof(float32_t));
