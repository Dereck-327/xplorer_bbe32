...
void cqrnfTakeColumn16(float32_t* restrict x,float32_t* restrict xt,const float32_t* restrict A,int M,int N,int SA,int L)
{
    ...
    if (M == 13)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t3, pA, (SA - 12 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 12 * 2 * L) * sizeof(float32_t));

            vTmp = BBE_MOVNX16_FROMN_4X64(t3);
            BBE_SAVNX16_XP(vTmp, vX, pX, 2 * (M - 3 * (BBE_SIMD_WIDTH / 4)) * sizeof(float32_t));
        }
    ...
    else if (M == 14)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t2, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t2, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 13 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 13 * 2 * L) * sizeof(float32_t));
    ...
    else if (M == 15)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t1, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t1, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 14 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 14 * 2 * L) * sizeof(float32_t));
    ...
    else if (M == 16)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t2, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t2, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 15 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 15 * 2 * L) * sizeof(float32_t));
