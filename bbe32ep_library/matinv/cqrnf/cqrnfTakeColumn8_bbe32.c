...
void cqrnfTakeColumn8(float32_t* restrict x,float32_t* restrict xt,const float32_t* restrict A,int M,int N,int SA,int L)
{
    ...
    if (M == 5)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t3, pA, (SA - 4 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 4 * 2 * L) * sizeof(float32_t));

            vTmp = BBE_MOVNX16_FROMN_4X64(t3);
            BBE_SAVNX16_XP(vTmp, vX, pX, 2 * (M - (BBE_SIMD_WIDTH / 4)) * sizeof(float32_t));
        }
    ...
    else if (M == 6)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t2, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t2, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 5 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 5 * 2 * L) * sizeof(float32_t));
    ...
    else if (M == 7)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t1, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t1, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 6 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 6 * 2 * L) * sizeof(float32_t));
    ...
    else if (M == 8)
    {
        for (l = 0; l < L; l++)
        {
            ...
            BBE_LSN_4X64_XP(t2, pA, 2 * N * sizeof(float32_t));
            BBE_SSN_4X64_XP(t2, pXt, 2 * L * sizeof(float32_t));
            BBE_LSN_4X64_XP(t3, pA, (SA - 7 * 2 * N) * sizeof(float32_t));
            BBE_SSN_4X64_XP(t3, pXt, (2 - 7 * 2 * L) * sizeof(float32_t));
