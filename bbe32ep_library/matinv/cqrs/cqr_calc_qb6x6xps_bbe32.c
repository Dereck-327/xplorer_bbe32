...
#define SIZE_OF_V6x6    SIZE_OF_V(6,6)
#define SIZE_OF_FI6x6  6
...
int cqr_calc_qb6x6xps(int16_t *B, const int16_t *V, int P, int L)
{
    ...
    xb_vecNx16 v0, v1, v2, v3, v4, v5;
    xb_vecNx16 r0, r1, r2, r3, r4, r5;
    xb_vecNx16 fi0, fi1, fi2, fi3, fi4, fi5;
    xb_vecNx40 acc;
    ...
    for (p = 0; p < P; p++)
    {
        ...
        for (l = 0; l < (L >> (LOG2_BBE_SIMD_WIDTH - 1)); l++)
        {
            ...
            BBE_LVNX16_XP(v5, _pv, 21 * 2 * BBE_SIMD_WIDTH);
            ...
            BBE_LVNX16_XP(r3, _pr, 4 * L*P);
            BBE_LVNX16_XP(r4, _pr, 4 * L*P);
            BBE_LVNX16_XP(r5, _pr, -5 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
            ...
            BBE_SVNX16_XP(r5, _pw, -5 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
        }

        __Pragma("no_reorder")
            _pv = (const xb_vecNx16 *)(V + 6 * BBE_SIMD_WIDTH);
        _pr = (const xb_vecNx16 *)(B + 1 * L*P * 2);
        _pw = (xb_vecNx16 *)_pr;
        for (l = 0; l < (L >> (LOG2_BBE_SIMD_WIDTH - 1)); l++)
        {
            BBE_LVNX16_IP(v1, _pv, 2 * BBE_SIMD_WIDTH);
            ...
            BBE_LVNX16_IP(v3, _pv, 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_IP(v4, _pv, 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_XP(v5, _pv, 22 * 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_XP(r1, _pr, 4 * L*P);
            BBE_LVNX16_XP(r2, _pr, 4 * L*P);
            BBE_LVNX16_XP(r3, _pr, 4 * L*P);
            BBE_LVNX16_XP(r4, _pr, 4 * L*P);
            BBE_LVNX16_XP(r5, _pr, -4 * 4 * L*P);
            ...
            BBE_LVNX16_XP(r3, _pr, 4 * L*P);
            BBE_LVNX16_XP(r4, _pr, 4 * L*P);
            BBE_LVNX16_XP(r5, _pr, -4 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
            acc = BBE_MULRNX16(r1, _0x4000, q); BBE_MULSNX16C(acc, v1, vr); r1 = BBE_PACKVNX40(acc, q);
            acc = BBE_MULRNX16(r2, _0x4000, q); BBE_MULSNX16C(acc, v2, vr); r2 = BBE_PACKVNX40(acc, q);
            acc = BBE_MULRNX16(r3, _0x4000, q); BBE_MULSNX16C(acc, v3, vr); r3 = BBE_PACKVNX40(acc, q);
            acc = BBE_MULRNX16(r4, _0x4000, q); BBE_MULSNX16C(acc, v4, vr); r4 = BBE_PACKVNX40(acc, q);
            ...
            BBE_SVNX16_XP(r3, _pw, 4 * L*P);
            BBE_SVNX16_XP(r4, _pw, 4 * L*P);
            BBE_SVNX16_XP(r5, _pw, -4 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
        }

        __Pragma("no_reorder")
            _pv = (const xb_vecNx16 *)(V + 11 * BBE_SIMD_WIDTH);
        _pr = (const xb_vecNx16 *)(B + 2 * L*P * 2);
        _pw = (xb_vecNx16 *)_pr;
        for (l = 0; l < (L >> (LOG2_BBE_SIMD_WIDTH - 1)); l++)
        {
            BBE_LVNX16_IP(v2, _pv, 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_IP(v3, _pv, 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_IP(v4, _pv, 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_XP(v5, _pv, 23 * 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_XP(r2, _pr, 4 * L*P);
            BBE_LVNX16_XP(r3, _pr, 4 * L*P);
            BBE_LVNX16_XP(r4, _pr, 4 * L*P);
            BBE_LVNX16_XP(r5, _pr, -3 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
            ...
            BBE_SVNX16_XP(r3, _pw, 4 * L*P);
            BBE_SVNX16_XP(r4, _pw, 4 * L*P);
            BBE_SVNX16_XP(r5, _pw, -3 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
        }

        __Pragma("no_reorder")
            _pv = (const xb_vecNx16 *)(V + 15 * BBE_SIMD_WIDTH);
        _pr = (const xb_vecNx16 *)(B + 2 * L*P * 3);
        _pw = (xb_vecNx16 *)_pr;
        for (l = 0; l < (L >> (LOG2_BBE_SIMD_WIDTH - 1)); l++)
        {
            BBE_LVNX16_IP(v3, _pv, 2 * BBE_SIMD_WIDTH);
            ...
            BBE_LVNX16_XP(r3, _pr, 4 * L*P);
            BBE_LVNX16_XP(r4, _pr, 4 * L*P);
            BBE_LVNX16_XP(r5, _pr, -2 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
            ...
            acc = BBE_MULRNX16(r5, _0x4000, q); BBE_MULSNX16C(acc, v5, vr); r5 = BBE_PACKVNX40(acc, q);
            BBE_SVNX16_XP(r4, _pw, 4 * L*P);
            BBE_SVNX16_XP(r5, _pw, -2 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
        }
        __Pragma("no_reorder")
            // final rotation
            _pr = (const xb_vecNx16 *)B;
        _pw = (xb_vecNx16 *)B;
        pFi = (const xb_vecNx16*)(V + BBE_SIMD_WIDTH*SIZE_OF_V6x6);
        for (l = 0; l < (L >> (LOG2_BBE_SIMD_WIDTH - 1)); l++)
        {
            ...
            BBE_LVNX16_XP(fi5, pFi, (SIZE_OF_V6x6 + 1) * 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_XP(r5, _pr, -5 * 4 * L*P + 2 * BBE_SIMD_WIDTH);
