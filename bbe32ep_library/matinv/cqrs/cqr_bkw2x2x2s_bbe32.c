...
void cqr_bkw2x2x2s (void* pScr, complex_fract16* restrict _B, const complex_fract16* restrict _Q, const complex_fract16* restrict  _R, int L)
{
          int16_t* restrict B=(      int16_t*)_B;
    const int16_t* restrict Q=(const int16_t*)_Q;
    ...
    */
    /*pQ00 = (xb_vecNx16*) (Q);
    pQ01 = (xb_vecNx16*) (Q+L*2);
    pQ10 = (xb_vecNx16*) (Q+2*L*2);
    pQ11 = (xb_vecNx16*) (Q+3*L*2); */
...
#pragma no_reorder
    ...
    pBr0 = (xb_vecNx16*)(B + 2 * 2 * L);
    pBr1 = (xb_vecNx16*)(B + 0 * 2 * L);
...

    {
        ...
        {
            b11 = BBE_LVNX16_X(pBr0, 1 * 4 * L);
            BBE_LVNX16_IP(b10, pBr0, (2 * BBE_SIMD_WIDTH));
            b01 = BBE_LVNX16_X(pBr1, 1 * 4 * L);
            BBE_LVNX16_IP(b00, pBr1, (2 * BBE_SIMD_WIDTH));
            q11 = BBE_LVNX16_X(pQ, 3 * 4 * L);
            q10 = BBE_LVNX16_X(pQ, 2 * 4 * L);
            q01 = BBE_LVNX16_X(pQ, 1 * 4 * L);
            BBE_LVNX16_IP(q00, pQ, (2 * BBE_SIMD_WIDTH));

            w0 = BBE_MULNX16J(b00, q00);
            BBE_MULANX16J(w0, b10, q10);
            w1 = BBE_MULNX16J(b00, q01);
            BBE_MULANX16J(w1, b10, q11);
            b00 = BBE_PACKQNX40(w0);
            b10 = BBE_PACKQNX40(w1);

            w0 = BBE_MULNX16J(b01, q00);
            BBE_MULANX16J(w0, b11, q10);
            w1 = BBE_MULNX16J(b01, q01);
            BBE_MULANX16J(w1, b11, q11);
            b01 = BBE_PACKQNX40(w0);
            b11 = BBE_PACKQNX40(w1);

            r01 = BBE_LVNX16_X(pR00, 1 * 4 * L);
            r11 = BBE_LVNX16_X(pR00, 3 * 4 * L);
            BBE_LVNX16_IP(r00, pR00, (2 * BBE_SIMD_WIDTH));
            t = BBE_SHFLNX16I(r11, BBE_SHFLI_DUPLICATE_1_EVEN);
            shft = BBE_NSANX16(t);
            ...
            BBE_SVNX16_X(b11, pBw, 3 * 4 * L);
            BBE_SVNX16_X(b10, pBw, 2 * 4 * L);
            BBE_SVNX16_X(b01, pBw, 1 * 4 * L);
            BBE_SVNX16_IP(b00, pBw, (2 * BBE_SIMD_WIDTH));
        }
    }
} /* cqr_bkw2x2x2s() */
#else
DISCARD_FUN(void,cqr_bkw2x2x2s,(void* pScr, complex_fract16* restrict B,const complex_fract16* restrict Q, const complex_fract16* restrict R, int L))
#endif
