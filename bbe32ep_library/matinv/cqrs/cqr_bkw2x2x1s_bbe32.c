...
void cqr_bkw2x2x1s (void* pScr, complex_fract16* restrict _B, const complex_fract16* restrict _Q, const complex_fract16* restrict  _R, int L)
{
    ...
    */
    ...
    pR00 = (xb_vecNx16*) (R); 
    pR01 = (xb_vecNx16*) (R+L*2);
    pR11 = (xb_vecNx16*) (R+3*L*2); 

    {
        ...
        for(l = 0; l<L; l+=(BBE_SIMD_WIDTH/2))
        {
            ...
            b10=BBE_LVNX16_X ( pB00, 1*4*L-(2*BBE_SIMD_WIDTH)); 
            ...
            BBE_SVNX16_X (b10, pB10, 1*4*L-(2*BBE_SIMD_WIDTH)); 
        }
    }
} /* cqr_bkw2x2x1s() */
#else
DISCARD_FUN(void,cqr_bkw2x2x1s,(void* pScr, complex_fract16* restrict B,const complex_fract16* restrict Q, const complex_fract16* restrict R, int L))
#endif
