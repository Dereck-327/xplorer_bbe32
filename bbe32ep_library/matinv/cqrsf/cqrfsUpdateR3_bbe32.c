                        ...
                        int K,int M,int N, int L)
{
    ...
    xb_vecN_2xf32 Acc, Acc1, V0, V1, V2, R0, R1, R2, Z0;
    ...
    for (l = 0; l < (N - K)*L; l += (BBE_SIMD_WIDTH / 4))
    {
        ...
        R2 = BBE_LVN_2XF32_X(pRr, 4 * N*L * sizeof(float32_t));
        Acc = BBE_MULMN_2XF32(V2, R2, 0, 4);
        Acc1 = BBE_MULMN_2XF32(V2, R2, 2, 11);
        V1 = BBE_LVN_2XF32_X(pV, 2 * L * sizeof(float32_t));
        R1 = BBE_LVN_2XF32_X(pRr, 2 * N*L * sizeof(float32_t));
