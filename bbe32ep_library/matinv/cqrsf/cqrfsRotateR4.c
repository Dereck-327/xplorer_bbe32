...
void cqrfsRotateR4(float32_t* restrict R,const float32_t* restrict Fi,int M, int N,int L)
{
    ...
    const xb_vecN_2xf32 * restrict pF2;
    ...
    pF2 = (const xb_vecN_2xf32 *)(Fi + 6 * L);
    pR = (xb_vecN_2xf32 *)R;
    ...
    for (l = 0; l < L; l += (BBE_SIMD_WIDTH / 4))
    {
        ...
        BBE_LVN_2XF32_XP(R0, pRr, 2 * L * sizeof(float32_t));
        Acc = BBE_MULMN_2XF32(F0, R0, 0, 4);
        BBE_MULMASN_2XF32(Acc, F0, R0, 2, 11);
        BBE_SVN_2XF32_XP(Acc, pR, 2 * L * sizeof(float32_t));
        ...
        BBE_LVN_2XF32_IP(F0, pF2, 2 * BBE_SIMD_WIDTH);
        ...
        BBE_LVN_2XF32_XP(R0, pRr, 2 * BBE_SIMD_WIDTH - 15 * 2 * L * sizeof(float32_t));
        Acc = BBE_MULMN_2XF32(F0, R0, 0, 4);
        BBE_MULMASN_2XF32(Acc, F0, R0, 2, 11);
        BBE_SVN_2XF32_XP(Acc, pR, 2 * BBE_SIMD_WIDTH - 15 * 2 * L * sizeof(float32_t));
    }
}
#endif
