...
{
    int p,n,l;
    complex_float x[16][BBE_SIMD_WIDTH/4];
    if (layout==e4x4_stream)
    {
        for (l=0; l<L; l+=BBE_SIMD_WIDTH/4,X+=BBE_SIMD_WIDTH/4)
        {
            for (n=0; n<16; n+=BBE_SIMD_WIDTH/4) 
            for (p=0; p<BBE_SIMD_WIDTH/4 ; p++)
            {
                x[p   ][n>>2]= X[p+L*(n+0)];
                x[p+ 4][n>>2]= X[p+L*(n+1)];
                x[p+ 8][n>>2]= X[p+L*(n+2)];
                x[p+12][n>>2]= X[p+L*(n+3)];
            }
            for (p=0; p<BBE_SIMD_WIDTH/4 ; p++)
            for (n=0; n<16; n++) X[p+L*n]=x[n][p];
        }
    }
    else
    {
        ...
        for (l=0; l<L; l+=BBE_SIMD_WIDTH/4,X+=16*BBE_SIMD_WIDTH/4)
        {
            ...
            for (p=0; p<BBE_SIMD_WIDTH/4; p++)
            {
                for (n=0; n<16; n++) X[p+n*BBE_SIMD_WIDTH/4]=x[n][p];
            }
        }
    }
}
#else
{
  ...
  __Pragma("loop_count min=1");
    ...
    {
        BBE_LVN_4XCF32_XP(x0 , px,  4*estride);
        BBE_LVN_4XCF32_XP(x1 , px,  4*estride);
        BBE_LVN_4XCF32_XP(x2 , px,  4*estride);
        BBE_LVN_4XCF32_XP(x3 , px,-11*estride);
        BBE_LVN_4XCF32_XP(x4 , px,  4*estride);
        BBE_LVN_4XCF32_XP(x5 , px,  4*estride);
        BBE_LVN_4XCF32_XP(x6 , px,  4*estride);
        BBE_LVN_4XCF32_XP(x7 , px,-11*estride);
        BBE_LVN_4XCF32_XP(x8 , px,  4*estride);
        BBE_LVN_4XCF32_XP(x9 , px,  4*estride);
        BBE_LVN_4XCF32_XP(x10, px,  4*estride);
        BBE_LVN_4XCF32_XP(x11, px,-11*estride);
        BBE_LVN_4XCF32_XP(x12, px,  4*estride);
        BBE_LVN_4XCF32_XP(x13, px,  4*estride);
        BBE_LVN_4XCF32_XP(x14, px,  4*estride);
        ...
        BBE_SVN_4XCF32_XP(x0 , py, estride);
        BBE_SVN_4XCF32_XP(x1 , py, estride);
        BBE_SVN_4XCF32_XP(x2 , py, estride);
        BBE_SVN_4XCF32_XP(x3 , py, estride);
        BBE_SVN_4XCF32_XP(x4 , py, estride);
        BBE_SVN_4XCF32_XP(x5 , py, estride);
        BBE_SVN_4XCF32_XP(x6 , py, estride);
        BBE_SVN_4XCF32_XP(x7 , py, estride);
        BBE_SVN_4XCF32_XP(x8 , py, estride);
        BBE_SVN_4XCF32_XP(x9 , py, estride);
        BBE_SVN_4XCF32_XP(x10, py, estride);
        BBE_SVN_4XCF32_XP(x11, py, estride);
        BBE_SVN_4XCF32_XP(x12, py, estride);
        BBE_SVN_4XCF32_XP(x13, py, estride);
        BBE_SVN_4XCF32_XP(x14, py, estride);
