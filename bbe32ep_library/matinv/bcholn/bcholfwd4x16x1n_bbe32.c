...
---------------------------------------------------------------------------*/
#if !HAVE_BCHOLN
DISCARD_FUN(void,bcholfwd4x16x1n ,(
            ...
            int L))
#else
void bcholfwd4x16x1n (complex_fract16* restrict Yt,
                const complex_fract16* restrict Rt,
                const complex_fract16* restrict D,
                const complex_fract16* restrict At,
                const complex_fract16* restrict Bt,
...
{
    if (L <= 0) return;
    bcholfwd4xnx1n ((int16_t*)Yt, (const int16_t*)Rt, (const int16_t*)D, (const int16_t*)At, (const int16_t*)Bt, qY-qB,16, L);
} /* bcholfwd4x16x1n() */
#endif
