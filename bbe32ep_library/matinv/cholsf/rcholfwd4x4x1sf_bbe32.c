...
---------------------------------------------------------------------------*/
#if !(HAVE_VFPU)
DISCARD_FUN(void, rcholfwd4x4x1sf,(
          ...
          int L)
{
    ...
    {
        A0 = BBE_LVN_2XF32_X(pA, 3 * 4 * L * sizeof(float32_t));
        B0 = BBE_LVN_2XF32_X(pB, 3 * L * sizeof(float32_t));
        ...
        A0 = BBE_LVN_2XF32_X(pA, 4 * L * sizeof(float32_t));
