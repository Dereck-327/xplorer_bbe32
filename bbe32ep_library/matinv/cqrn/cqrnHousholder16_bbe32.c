                    ...
                    int M, int SD, int L)
{
    ...
    NbM = M*2*sz_i16-1*sz_i16*BBE_SIMD_WIDTH;
    ...
    for (l=0; l<L; l++)
    {
        ...
        BBE_LAVNX16_XP(X1, al_pX, pX, NbM);
    ...
    for (l=0; l<(L_>>(LOG2_BBE_SIMD_WIDTH-1)); l++)
    {
        ...
        ACC1 = BBE_MULUSRNX16(U0, X1, U0_exp);
        X0 = BBE_PACKVNX40(ACC0, U0_exp);
        X1 = BBE_PACKVNX40(ACC1, U0_exp);
        T1 = BBE_REPNX16C(V0, 0);
        X0 = BBE_MOVNX16T(X0, T1, mask);
        BBE_SANX16_IP (X0, al_pV, pV);
        BBE_SAVNX16_XP(X1, al_pV, pV, NbM);

        BBE_LANX16_IP (X0, al_pX, pX);
        BBE_LAVNX16_XP(X1, al_pX, pX, NbM);
        ACC0 = BBE_MULUSRNX16(U1, X0, U1_exp);
        ACC1 = BBE_MULUSRNX16(U1, X1, U1_exp);
        X0 = BBE_PACKVNX40(ACC0, U1_exp);
        X1 = BBE_PACKVNX40(ACC1, U1_exp);
        ...
        ACC1 = BBE_MULUSRNX16(U2, X1, U2_exp);
        X0 = BBE_PACKVNX40(ACC0, U2_exp);
        X1 = BBE_PACKVNX40(ACC1, U2_exp);
        ...
        ACC1 = BBE_MULUSRNX16(U3, X1, U3_exp);
        X0 = BBE_PACKVNX40(ACC0, U3_exp);
        X1 = BBE_PACKVNX40(ACC1, U3_exp);
        ...
        ACC1 = BBE_MULUSRNX16(U4, X1, U4_exp);
        X0 = BBE_PACKVNX40(ACC0, U4_exp);
        X1 = BBE_PACKVNX40(ACC1, U4_exp);
        ...
        ACC1 = BBE_MULUSRNX16(U5, X1, U5_exp);
        X0 = BBE_PACKVNX40(ACC0, U5_exp);
        X1 = BBE_PACKVNX40(ACC1, U5_exp);
        ...
        ACC1 = BBE_MULUSRNX16(U6, X1, U6_exp);
        X0 = BBE_PACKVNX40(ACC0, U6_exp);
        X1 = BBE_PACKVNX40(ACC1, U6_exp);
        ...
        ACC1 = BBE_MULUSRNX16(U7, X1, U7_exp);
        X0 = BBE_PACKVNX40(ACC0, U7_exp);
        X1 = BBE_PACKVNX40(ACC1, U7_exp);
    ...
    for (l=0; l<Lmod; l++)
    {
        ...
        U1 = BBE_PACKVNX40(ACC1, U0_exp);
        U0 = BBE_MOVNX16T(U0, V0, mask);
        BBE_SANX16_IP (U0, al_pV, pV);
        BBE_SAVNX16_XP(U1, al_pV, pV, NbM);
    }
