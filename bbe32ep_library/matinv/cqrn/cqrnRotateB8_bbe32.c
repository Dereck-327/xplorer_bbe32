...
void cqrnRotateB8(void* pScr, int16_t* B,const int16_t* Fi,int L)
{
    ...
    if (Lmod)
    {
        ...
        BBE_SVNX16_IP(F0, pscr_st, sz_i16*BBE_SIMD_WIDTH);
        BBE_SVNX16_IP(F1, pscr_st, sz_i16*BBE_SIMD_WIDTH);
        BBE_SVNX16_IP(F2, pscr_st, sz_i16*BBE_SIMD_WIDTH);
        BBE_SVNX16_IP(F3, pscr_st, sz_i16*BBE_SIMD_WIDTH);
        BBE_SVNX16_IP(F4, pscr_st, sz_i16*BBE_SIMD_WIDTH);
        BBE_SVNX16_IP(F5, pscr_st, sz_i16*BBE_SIMD_WIDTH);
        BBE_SVNX16_IP(F6, pscr_st, sz_i16*BBE_SIMD_WIDTH);
