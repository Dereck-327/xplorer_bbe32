...
/* processing function D==2, M==4 */
static void firdec_proc_D2_M4(  int16_t * restrict y,
                  ...
                  int M, int N, int D )
{
  ...
  for (n = 0; n<N / (BBE_SIMD_WIDTH / 2); n++)
  {
      ...
      y0 = BBE_PACKQNX40(w0);
      BBE_SVNX16_XP(y0, Y, 2 * BBE_SIMD_WIDTH);
...
const tFirFxdxns firdec_2d_4_8n  ={&firdec_alloc_gen,firdec_proc_D2_M4 };
