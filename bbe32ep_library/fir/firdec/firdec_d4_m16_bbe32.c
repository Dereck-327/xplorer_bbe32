...
/* processing function D==4, M==16 */
static void firdec_proc_D4_M16( int16_t * restrict y,
                         ...
                         int M, int N, int D )
{
    ...
    xb_vecNx16 p20, p21, p22, p23;
    xb_vecNx16 p30, p31, p32, p33;
    uint32_t   q00, q01, q10, q11;
    uint32_t   q20, q21, q30, q31;
    ...
    x0 = BBE_LVNX16_I((const xb_vecNx16*)delayLine, 0 * 2 * BBE_SIMD_WIDTH);
    x1 = BBE_LVNX16_I((const xb_vecNx16*)delayLine, 1 * 2 * BBE_SIMD_WIDTH);

    d0 = BBE_SELNX16I(x0, x0, BBE_SELI_EXTRACT_LO_HALVES);
    d1 = BBE_SELNX16I(x0, x0, BBE_SELI_EXTRACT_HI_HALVES);

    d2 = BBE_SELNX16I(x1, x1, BBE_SELI_EXTRACT_LO_HALVES);
    d3 = BBE_SELNX16I(x1, x1, BBE_SELI_EXTRACT_HI_HALVES);
    ...
    for (n = 0; n<N / (BBE_SIMD_WIDTH / 2); n++)
    {
        ...
        BBE_SELPCNX16I(p01, p00, x0, d0, 5);
        BBE_SELPCNX16I(p03, p02, x0, d0, 7);
        ...
        BBE_SELPCNX16I(p11, p10, x1, d1, 4);
        BBE_SELPCNX16I(p13, p12, x1, d1, 6);
        ...
        BBE_SELPCNX16I(p21, p20, x2, d2, 4);
        BBE_SELPCNX16I(p23, p22, x2, d2, 6);
        ...
        BBE_SELPCNX16I(p31, p30, x3, d3, 4);
        BBE_SELPCNX16I(p33, p32, x3, d3, 6);

        d3 = x3;

        q30 = BBE_EXTRNX16C(cf, 4);
        q31 = BBE_EXTRNX16C(cf, 5);
    ...
    d1 = BBE_SELNX16I(d3, d2, BBE_SELI_EXTRACT_HI_HALVES);

    BBE_SVNX16_I(d0, (xb_vecNx16*)delayLine, 0 * 2 * BBE_SIMD_WIDTH);
    BBE_SVNX16_I(d1, (xb_vecNx16*)delayLine, 1 * 2 * BBE_SIMD_WIDTH);
} // firdec_proc_D4_M16()
const tFirFxdxns firdec_4d_16_8n ={&firdec_alloc_gen,firdec_proc_D4_M16};
