...
/* processing function D==2, M==8 */
static void firdec_proc_D2_M8 (  int16_t * restrict y,
                  ...
                  int M, int N, int D )
{
  ...
  for (n = 0; n<N / (BBE_SIMD_WIDTH / 2); n++)
  {
      ...
      q00 = BBE_EXTRNX16C(cf, 2);
      q01 = BBE_EXTRNX16C(cf, 3);
...
const tFirFxdxns firdec_2d_8_8n  ={&firdec_alloc_gen,firdec_proc_D2_M8 };
