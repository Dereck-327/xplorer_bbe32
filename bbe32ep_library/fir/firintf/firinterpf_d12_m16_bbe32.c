...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firinterpf_proc_D12_M16,( complex_float * restrict y,
                             const complex_float * restrict x,
                             const float32_t     * restrict coef,
                                   float32_t     * restrict delayLine,
                             int M, int N, int D ))
#else
void firinterpf_proc_D12_M16( complex_float * restrict y,
                               const complex_float * restrict x,
                               const float32_t     * restrict coef,
                                     float32_t     * restrict delayLine,
                               int M, int N, int D )
{
    ...
    xb_vecN_2xf32 c0, c1, h0, h1, h2, h3, h4, h5, h6, h7;
    ...
    for (d = 0; d < D; d++)
    {
        ...
        pH = (const xb_vecN_2xf32 *)coef + 2 * d;
        ...
        for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
        {
            ...
            h0 = BBE_REPN_2XF32(c1, 0);
            h1 = BBE_REPN_2XF32(c1, 1);
            h2 = BBE_REPN_2XF32(c1, 2);
            h3 = BBE_REPN_2XF32(c1, 3);
            h4 = BBE_REPN_2XF32(c1, 4);
            h5 = BBE_REPN_2XF32(c1, 5);
            h6 = BBE_REPN_2XF32(c1, 6);
            h7 = BBE_REPN_2XF32(c1, 7);
            ...
            x3 = d3;
            x4 = BBE_SELN_2XF32I(xx, d3, BBE_SELI_ROTATE_RIGHT_4);
            x5 = BBE_SELN_2XF32I(xx, d3, BBE_SELI_ROTATE_RIGHT_8);
            x6 = BBE_SELN_2XF32I(xx, d3, BBE_SELI_ROTATE_RIGHT_12);
            x7 = xx;
    ...
    firinterpf_12d_intlv(y, N);
}// firinterpf_proc_D12_M16
#endif

const tFirFxdxns interpf_12d_16m = { &firinterpf_d_6_12, firinterpf_proc_D12_M16 };
