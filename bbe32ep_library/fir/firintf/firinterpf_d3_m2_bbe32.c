...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firinterpf_proc_D3_M2,( complex_float * restrict y,
                             const complex_float * restrict x,
                             const float32_t     * restrict coef,
                                   float32_t     * restrict delayLine,
                             int M, int N, int D ))
#else
void firinterpf_proc_D3_M2( complex_float * restrict y,
                             const complex_float * restrict x,
                             const float32_t     * restrict coef,
                                   float32_t     * restrict delayLine,
                             int M, int N, int D )
{
    ...
    xb_vecN_2xf32 c0, h0, h1, h2, h3, h4, h5;
    xb_vecN_2xf32 x0, x1;
    xb_vecN_2xf32 d0, d1;
...
}// firinterpf_proc_D3_M2
#endif

const tFirFxdxns interpf_3d_2m = { &firinterpf_dx, firinterpf_proc_D3_M2 };
