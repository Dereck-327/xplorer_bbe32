...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firinterpf_proc_D4_M8,( complex_float * restrict y,
                             const complex_float * restrict x,
                             const float32_t     * restrict coef,
                                   float32_t     * restrict delayLine,
                             int M, int N, int D ))
#else
void firinterpf_proc_D4_M8( complex_float * restrict y,
                             const complex_float * restrict x,
                             const float32_t     * restrict coef,
                                   float32_t     * restrict delayLine,
                             int M, int N, int D )
{
    ...
    xb_vecN_2xf32 d0, d1, d2, d3, d4, d5, d6, d7;
    ...
    BBE_LVN_2XF32_IP(d6, pD, 2 * BBE_SIMD_WIDTH);
    BBE_LVN_2XF32_IP(d7, pD, -2 * BBE_SIMD_WIDTH);
    
    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        d0 = BBE_SHFLN_2XF32I(d6, BBE_SHFLI_REP_1X4);
        d1 = BBE_SHFLN_2XF32I(d6, BBE_SHFLI_REP_2X4);
        d2 = BBE_SHFLN_2XF32I(d6, BBE_SHFLI_REP_3X4);
        d3 = BBE_SHFLN_2XF32I(d7, BBE_SHFLI_REP_0X4);
        d4 = BBE_SHFLN_2XF32I(d7, BBE_SHFLI_REP_1X4);
        d5 = BBE_SHFLN_2XF32I(d7, BBE_SHFLI_REP_2X4);
        d6 = BBE_SHFLN_2XF32I(d7, BBE_SHFLI_REP_3X4);
        ...
        y1 = BBE_MULN_2XF32(d1, h0);
        y2 = BBE_MULN_2XF32(d2, h0);
        y3 = BBE_MULN_2XF32(d3, h0);
        BBE_MULAN_2XF32(y0, d1, h1);
        BBE_MULAN_2XF32(y1, d2, h1);
        BBE_MULAN_2XF32(y2, d3, h1);
        BBE_MULAN_2XF32(y3, d4, h1);

        BBE_LVN_2XF32_XP(c0, pH, 2 * BBE_SIMD_WIDTH);
        h0 = BBE_SHFLN_2XF32I(c0, BBE_SHFLI_DOUBLE_2_LO);
        h1 = BBE_SHFLN_2XF32I(c0, BBE_SHFLI_DOUBLE_2_HI);
        BBE_MULAN_2XF32(y0, d2, h0);
        BBE_MULAN_2XF32(y1, d3, h0);
        BBE_MULAN_2XF32(y2, d4, h0);
        BBE_MULAN_2XF32(y3, d5, h0);
        BBE_MULAN_2XF32(y0, d3, h1);
        BBE_MULAN_2XF32(y1, d4, h1);
        BBE_MULAN_2XF32(y2, d5, h1);
        BBE_MULAN_2XF32(y3, d6, h1);

        BBE_LVN_2XF32_XP(c0, pH, 2 * BBE_SIMD_WIDTH);
        h0 = BBE_SHFLN_2XF32I(c0, BBE_SHFLI_DOUBLE_2_LO);
        h1 = BBE_SHFLN_2XF32I(c0, BBE_SHFLI_DOUBLE_2_HI);
        BBE_MULAN_2XF32(y0, d4, h0);
        BBE_MULAN_2XF32(y1, d5, h0);
        BBE_MULAN_2XF32(y2, d6, h0);
        BBE_MULAN_2XF32(y3, x0, h0);
        BBE_MULAN_2XF32(y0, d5, h1);
        BBE_MULAN_2XF32(y1, d6, h1);
        BBE_MULAN_2XF32(y2, x0, h1);
        BBE_MULAN_2XF32(y3, x1, h1);

        BBE_LVN_2XF32_XP(c0, pH, -3 * 2 * BBE_SIMD_WIDTH);
        h0 = BBE_SHFLN_2XF32I(c0, BBE_SHFLI_DOUBLE_2_LO);
        h1 = BBE_SHFLN_2XF32I(c0, BBE_SHFLI_DOUBLE_2_HI);
        BBE_MULAN_2XF32(y0, d6, h0);
        BBE_MULAN_2XF32(y1, x0, h0);
        BBE_MULAN_2XF32(y2, x1, h0);
        BBE_MULAN_2XF32(y3, x2, h0);
        BBE_MULAN_2XF32(y0, x0, h1);
        BBE_MULAN_2XF32(y1, x1, h1);
        BBE_MULAN_2XF32(y2, x2, h1);
        BBE_MULAN_2XF32(y3, x3, h1);
    ...
    BBE_SVN_2XF32_IP(d6, pD, 2 * BBE_SIMD_WIDTH);
    BBE_SVN_2XF32_IP(d7, pD, -2 * BBE_SIMD_WIDTH);
}// firinterpf_proc_D4_M8
#endif

const tFirFxdxns interpf_4d_8m = { &firinterpf_dx, firinterpf_proc_D4_M8 };
