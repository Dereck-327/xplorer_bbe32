...
/* Filter processing function for D=3 M=2 and N=8*n */
static void filter_proc_3d_2_8n(  
                              void* handle,
                                 int16_t *  restrict  y,
...
const tFirFxdxns interp_3d_2_8n   ={&firinterp_dx, filter_proc_3d_2_8n};
