...
/* Filter processing function for D=4 M==2 and N%8==0 */
static void filter_proc_4d_2_8n (   
                              void* handle,
                                 int16_t *  restrict  y, 
...
const tFirFxdxns interp_4d_2_8n   ={&firinterp_dx,filter_proc_4d_2_8n} ;
