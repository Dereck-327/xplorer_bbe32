...
/* Filter processing function for D=6 M=16 and N=8*n */
static void filter_proc_6d_16_8n (        
                              void* handle,
                                 int16_t *  restrict  y,
                          ...
                          )
{
  ...
  uint32_t   c03, c02, c13, c12;
  uint32_t   c04, c05, c14, c15;
  uint32_t   c06, c07, c16, c17;
  ...
  for (k = 0; k<3; k++)
  {
      ...
      for (n = 0; n<N / (BBE_SIMD_WIDTH / 2); n++)
      {
          ...
          BBE_SVNX16_IP(y1, pY, 5 * 2 * BBE_SIMD_WIDTH);
...
const tFirFxdxns interp_6d_16_8n   ={&firinterp_dx, filter_proc_6d_16_8n };
