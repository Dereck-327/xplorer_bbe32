...
/* Filter processing function for D=6 M=32 and N=8*n */
static void filter_proc_6d_32_8n (        
                              void* handle,
                                 int16_t *  restrict  y,
...
const tFirFxdxns interp_6d_32_8n = { &firinterp_dx_m_32, filter_proc_6d_32_8n };
