...
static void filter_proc_12d_8_8n (   
                              void* handle,
                                 int16_t *  restrict  y,
                          ...
                          )
{
    ...
    const        int *  restrict pH1 = (const int        *)coef;
...
const tFirFxdxns interp_12d_8_8n   ={&firinterp_dx,filter_proc_12d_8_8n };
