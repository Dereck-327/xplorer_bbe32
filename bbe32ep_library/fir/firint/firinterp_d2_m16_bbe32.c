...
/* Filter processing function for D=2 M=16 and N=8*n */
static void filter_proc_2d_16_8n (          
                              void* handle,
                                 int16_t *  restrict  y,
                          ...
                          )
{
  ...
  for (n=0; n<N/(BBE_SIMD_WIDTH/2); n++)
  {
      ...
      CoefVec = BBE_LVNX16_I((const xb_vecNx16*)coef, 0);
      ...
      CoefVec = BBE_LVNX16_I((const xb_vecNx16*)coef, 2 * BBE_SIMD_WIDTH);
...
const tFirFxdxns interp_2d_16_8n  ={&firinterp_dx,&filter_proc_2d_16_8n };
