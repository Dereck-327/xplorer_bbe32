...
/* Filter processing function for D=12 M=mx and N=8*n. */
static void filter_proc_12d_mx_8n (     
                              void* handle,
                                 int16_t *  restrict  y,
                          ...
                          )
{
    ...
    BBE_SVNX16_IP(d0,pD,0);
}
const tFirFxdxns interp_12d_mx_8n  ={&firinterp_d_6_12_mx,filter_proc_12d_mx_8n} ;
