...
/* Filter processing function for D=4 M=16*m and N=8*n */
static void filter_proc_4d_mx_8n (      
                         void* handle,
                         int16_t *  restrict  y,  
                          ...
                          )
{
    ...
    for (n = 0; n<N / (BBE_SIMD_WIDTH / 2); n++)
    {
        ...
        A0 = A1 = A2 = A3 = BBE_MOVWA32(0x1000);
        __Pragma("ymemory(pD)")
            __Pragma("ymemory(pH)")
        ...
        for (m = 0; m<M / (BBE_SIMD_WIDTH); m++)
        {
            ...
            c06 = XT_L32I((const int        *)pH, 32);
            c16 = XT_L32I((const int        *)pH, 36);
            c26 = XT_L32I((const int        *)pH, 40);
            c36 = XT_L32I((const int        *)pH, 44);
            c07 = XT_L32I((const int        *)pH, 48);
...
const tFirFxdxns interp_4d_mx_8n  ={&firinterp_dx,filter_proc_4d_mx_8n};
