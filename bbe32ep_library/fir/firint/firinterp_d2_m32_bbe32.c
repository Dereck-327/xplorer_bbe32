...
/* Filter processing function for D=2 M=32 and N=8*n */
static void filter_proc_2d_32_8n (          
                              void* handle,
                                 int16_t *  restrict  y,
...
const tFirFxdxns interp_2d_32_8n = { &firinterp_dx_m_32, &filter_proc_2d_32_8n };
