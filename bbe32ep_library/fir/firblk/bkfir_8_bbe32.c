...
void bkfir_process_8(int16_t* restrict delay, int16_t* restrict y, const int16_t * restrict x, const int16_t* restrict h, int M, int N)
{
  ...
  for (n=0; n<(N/BBE_SIMD_WIDTH); n++)
  {
    ...
    BBE_SELPRNX16I(x1, x0, d1, d0, 9); w0 = BBE_MULNX16PR(x0, x1, h0);
    BBE_SELPRNX16I(x1, x0, d1, d0, 11); BBE_MULANX16PR(w0, x0, x1, h1);
    BBE_SELPRNX16I(x1, x0, d1, d0, 13); BBE_MULANX16PR(w0, x0, x1, h2);
    BBE_SELPRNX16I(x1, x0, d1, d0, 15); BBE_MULANX16PR(w0, x0, x1, h3);
