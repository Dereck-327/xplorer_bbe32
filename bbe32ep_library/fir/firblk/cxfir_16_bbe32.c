...
void cxfir_process_16(complex_fract16 * restrict y, const complex_fract16 * restrict x, const int16_t * restrict coef, int16_t * restrict delayLine, int M, int N)
{
  ...
  d1 = BBE_LVNX16_I(D, 0 * 2 * BBE_SIMD_WIDTH);
  d2 = BBE_LVNX16_I(D, 1 * 2 * BBE_SIMD_WIDTH);
  ...
  for (n=0; n<N/(BBE_SIMD_WIDTH/2); n++)
  {
      ...
      BBE_LVNX16_IP(c1, H, -2 * BBE_SIMD_WIDTH);
      h0 = BBE_REPNX16C(c1, 0);
      h1 = BBE_REPNX16C(c1, 1);
      h2 = BBE_REPNX16C(c1, 2);
      h3 = BBE_REPNX16C(c1, 3);
      h4 = BBE_REPNX16C(c1, 4);
      h5 = BBE_REPNX16C(c1, 5);
      h6 = BBE_REPNX16C(c1, 6);
      h7 = BBE_REPNX16C(c1, 7);

      x0 = BBE_SELNX16I(d2, d1, BBE_SELI_ROTATE_RIGHT_2);
      x1 = BBE_SELNX16I(d2, d1, BBE_SELI_ROTATE_RIGHT_4);
      x2 = BBE_SELNX16I(d2, d1, BBE_SELI_ROTATE_RIGHT_6);
      x3 = BBE_SELNX16I(d2, d1, BBE_SELI_ROTATE_RIGHT_8);
      x4 = BBE_SELNX16I(d2, d1, BBE_SELI_ROTATE_RIGHT_10);
      x5 = BBE_SELNX16I(d2, d1, BBE_SELI_ROTATE_RIGHT_12);
      x6 = BBE_SELNX16I(d2, d1, BBE_SELI_ROTATE_RIGHT_14);
      x7 = d2;

      BBE_MULANX16C(w0, x0, h0);
      BBE_MULANX16C(w0, x1, h1);
      BBE_MULANX16C(w0, x2, h2);
      BBE_MULANX16C(w0, x3, h3);
      BBE_MULANX16C(w0, x4, h4);
  ...
  BBE_SVNX16_IP(d2, D, 2 * BBE_SIMD_WIDTH);
} //cxfir_process_16()
