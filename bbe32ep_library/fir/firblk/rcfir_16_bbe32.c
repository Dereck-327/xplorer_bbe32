...
void rcfir_process_16(int16_t * restrict delay, complex_fract16 * restrict y, const complex_fract16 * restrict x, const int16_t * restrict h, int M, int N)
{
    ...
    xb_vecNx16 d0, d1, d2;
    xb_vecNx16 p0, p1, p2, p3, p4, p5, p6, p7;
    xb_vecNx16 y0;
    xb_vecNx16 h_;
    xb_vecNx40 w0;
    ...
    {   
        ...
        h2 = BBE_EXTRNX16C(h_, 2);
        h3 = BBE_EXTRNX16C(h_, 3);
        h4 = BBE_EXTRNX16C(h_, 4);
        h5 = BBE_EXTRNX16C(h_, 5);
        h6 = BBE_EXTRNX16C(h_, 6);
        h7 = BBE_EXTRNX16C(h_, 7);


        BBE_LVNX16_IP(d2, X, 2 * BBE_SIMD_WIDTH);
        BBE_SELPCNX16I(p1, p0, d2, d1, 7);
        BBE_SELPCNX16I(p3, p2, d2, d1, 5);
        BBE_SELPCNX16I(p5, p4, d2, d1, 3);
        BBE_SELPCNX16I(p7, p6, d2, d1, 1);

        w0 = BBE_MULNX16PR(p0, p1, h0);
        BBE_MULANX16PR(w0, p2, p3, h1);
        BBE_MULANX16PR(w0, p4, p5, h2);
        BBE_MULANX16PR(w0, p6, p7, h3);


        BBE_SELPCNX16I(p1, p0, d1, d0, 7);
        BBE_SELPCNX16I(p3, p2, d1, d0, 5);
        BBE_SELPCNX16I(p5, p4, d1, d0, 3);
        BBE_SELPCNX16I(p7, p6, d1, d0, 1);

        BBE_MULANX16PR(w0, p0, p1, h4);
        BBE_MULANX16PR(w0, p2, p3, h5);
        BBE_MULANX16PR(w0, p4, p5, h6);
        BBE_MULANX16PR(w0, p6, p7, h7);
