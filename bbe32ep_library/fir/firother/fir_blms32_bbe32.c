...
void fir_blms32(void * pScr, complex_fract16 * restrict e,
                       ...
                       int32_t norm, int16_t mu, int N)
{
    ...
    // convert IR from Q30 to Q15 and save in reversed order
    {
        ...
        pHw = (xb_vecNx16*)(pScr);
        pHr = (const xb_vecNx16*)(h + (8 * 32 - 2 * BBE_SIMD_WIDTH) / sizeof(complex_fract32));
    ...
    // compute error
    {
        ...
        for (n = 0; n < N / (BBE_SIMD_WIDTH / 2); n++)
        {
            ...
            BBE_LVNX16_IP(H0, pHr, 2 * BBE_SIMD_WIDTH);
            ...
            BBE_LVNX16_XP(X1, pX, -3 * 2 * BBE_SIMD_WIDTH);
            BBE_LVNX16_XP(H0, pHr,-3 * 2 * BBE_SIMD_WIDTH);
            X = X0;                                            H = BBE_REPNX16C(H0, 0); BBE_MULSNX16C(A, X, H);
            X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_2); H = BBE_REPNX16C(H0, 1); BBE_MULSNX16C(A, X, H);
            X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_4); H = BBE_REPNX16C(H0, 2); BBE_MULSNX16C(A, X, H);
            X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_6); H = BBE_REPNX16C(H0, 3); BBE_MULSNX16C(A, X, H);
    ...
    // compute correlation 
    {
        ...
        for (m = 0; m < 2; m++)
        {
            ...
            for (n = 0; n < N / (BBE_SIMD_WIDTH / 2); n++)
            {
                ...
                X = X0;                                             E = BBE_REPNX16C(E0, 0); BBE_MULANX16J(A0, X, E);
                X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_2);  E = BBE_REPNX16C(E0, 1); BBE_MULANX16J(A0, X, E);
                X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_4);  E = BBE_REPNX16C(E0, 2); BBE_MULANX16J(A0, X, E);
                X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_6);  E = BBE_REPNX16C(E0, 3); BBE_MULANX16J(A0, X, E);

                X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_8);  E = BBE_REPNX16C(E0, 4); BBE_MULANX16J(A0, X, E);
                X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_10); E = BBE_REPNX16C(E0, 5); BBE_MULANX16J(A0, X, E);
                X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_12); E = BBE_REPNX16C(E0, 6); BBE_MULANX16J(A0, X, E);
                X = BBE_SELNX16I(X1, X0, BBE_SELI_ROTATE_RIGHT_14); E = BBE_REPNX16C(E0, 7); BBE_MULANX16J(A0, X, E);

                BBE_LVNX16_IP(X2, pX, 2 * BBE_SIMD_WIDTH);

                X = X1;                                             E = BBE_REPNX16C(E0, 0); BBE_MULANX16J(A1, X, E);
                X = BBE_SELNX16I(X2, X1, BBE_SELI_ROTATE_RIGHT_2);  E = BBE_REPNX16C(E0, 1); BBE_MULANX16J(A1, X, E);
                X = BBE_SELNX16I(X2, X1, BBE_SELI_ROTATE_RIGHT_4);  E = BBE_REPNX16C(E0, 2); BBE_MULANX16J(A1, X, E);
                X = BBE_SELNX16I(X2, X1, BBE_SELI_ROTATE_RIGHT_6);  E = BBE_REPNX16C(E0, 3); BBE_MULANX16J(A1, X, E);

                X = BBE_SELNX16I(X2, X1, BBE_SELI_ROTATE_RIGHT_8);  E = BBE_REPNX16C(E0, 4); BBE_MULANX16J(A1, X, E);
                X = BBE_SELNX16I(X2, X1, BBE_SELI_ROTATE_RIGHT_10); E = BBE_REPNX16C(E0, 5); BBE_MULANX16J(A1, X, E);
                X = BBE_SELNX16I(X2, X1, BBE_SELI_ROTATE_RIGHT_12); E = BBE_REPNX16C(E0, 6); BBE_MULANX16J(A1, X, E);
                X = BBE_SELNX16I(X2, X1, BBE_SELI_ROTATE_RIGHT_14); E = BBE_REPNX16C(E0, 7); BBE_MULANX16J(A1, X, E);

                X0 = X1;
                X1 = X2;
            }

            pX = (const xb_vecNx16*)XT_ADDX4(-N, (uintptr_t)pX);
            pE = (      xb_vecNx16*)XT_ADDX4(-N, (uintptr_t)pE);   // get back on the beginning
