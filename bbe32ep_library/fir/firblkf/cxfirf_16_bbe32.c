...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN(void,cxfirf_process_16,(complex_float * restrict y, const complex_float * restrict x, const float32_t * restrict coef, float32_t * restrict delayLine, int M, int N))
#else
void cxfirf_process_16(complex_float * restrict y, const complex_float * restrict x, const float32_t * restrict coef, float32_t * restrict delayLine, int M, int N)
{
    int n;
    ...
    xb_vecN_2xf32 d0, d1, d2, d3, d4, c0;
    ...
    BBE_LVN_2XF32_XP(d4, pD, -3 * 2 * BBE_SIMD_WIDTH);
    ...
    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        ...
        d2 = d3;
        d3 = d4;
        BBE_LVN_2XF32_IP(d4, pX, 2 * BBE_SIMD_WIDTH);
        ...
        A0 = BBE_MULMN_2XF32(x0, h0, 0, 4);
        A1 = BBE_MULMN_2XF32(x0, h0, 1, 11);
        A2 = BBE_MULMN_2XF32(x1, h1, 0, 4);
        A3 = BBE_MULMN_2XF32(x1, h1, 1, 11);
        ...
        x0 = BBE_SELN_2XF32I(d3, d2, BBE_SELI_ROTATE_RIGHT_4);
        x1 = BBE_SELN_2XF32I(d3, d2, BBE_SELI_ROTATE_RIGHT_8);
        x2 = BBE_SELN_2XF32I(d3, d2, BBE_SELI_ROTATE_RIGHT_12);
        x3 = d3;
        ...
        x0 = BBE_SELN_2XF32I(d4, d3, BBE_SELI_ROTATE_RIGHT_4);
        x1 = BBE_SELN_2XF32I(d4, d3, BBE_SELI_ROTATE_RIGHT_8);
        x2 = BBE_SELN_2XF32I(d4, d3, BBE_SELI_ROTATE_RIGHT_12);
        x3 = d4;
    ...
    BBE_SVN_2XF32_IP(d3, pD, 2 * BBE_SIMD_WIDTH);
    BBE_SVN_2XF32_XP(d4, pD, -3 * 2 * BBE_SIMD_WIDTH);
} //cxfir_process_8m()
#endif
