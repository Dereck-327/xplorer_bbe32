...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN(void,rcfirf_process_8,(complex_float * restrict y, const complex_float * restrict x, const float32_t * restrict h, float32_t * restrict delay, int M, int N))
#else
void rcfirf_process_8(complex_float * restrict y, const complex_float * restrict x, const float32_t * restrict h, float32_t * restrict delay, int M, int N)
{
	int n;
