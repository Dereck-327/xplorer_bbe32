...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN(void,cxfirf_process_2,(complex_float * restrict y, const complex_float * restrict x, const float32_t * restrict coef, float32_t * restrict delayLine, int M, int N))
#else
void cxfirf_process_2(complex_float * restrict y, const complex_float * restrict x, const float32_t * restrict coef, float32_t * restrict delayLine, int M, int N)
{
    ...
    //d1 = BBE_SHFLN_2XF32I(d1, BBE_SHFLI_REP_0X4);
    ...
    {
        d0 = d1;
        BBE_LVN_2XF32_IP(d1, pX, 2 * BBE_SIMD_WIDTH);
    ...
    //d1 = BBE_SHFLN_2XF32I(d1, BBE_SHFLI_REP_3X4);
