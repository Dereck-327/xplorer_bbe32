...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firdecf_proc_D4_M4,( complex_float * restrict y,
                   ...
                   int M, int N, int D )
{
    ...
    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        ...
        BBE_DSELN_2XF32I(d2, d0, x2, x0, BBE_DSELI_INTERLEAVE_4);
        BBE_DSELN_2XF32I(d3, d1, x3, x1, BBE_DSELI_INTERLEAVE_4);
        BBE_DSELN_2XF32I(x1, x0, d1, d0, BBE_DSELI_INTERLEAVE_4);
        BBE_DSELN_2XF32I(x3, x2, d3, d2, BBE_DSELI_INTERLEAVE_4);
...
#endif
const tFirFxdxns firdecf_4d_4m = { &firdecf_alloc_dx, firdecf_proc_D4_M4 };
