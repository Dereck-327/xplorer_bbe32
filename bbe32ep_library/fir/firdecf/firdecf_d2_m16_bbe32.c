...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firdecf_proc_D2_M16,( complex_float * restrict y,
                   ...
                   int M, int N, int D )
{
    ...
    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        ...
        d2 = BBE_SELN_2XF32I(x3, x2, BBE_SELI_EXTRACT_4_OF_8_OFF_0);
        d3 = BBE_SELN_2XF32I(x3, x2, BBE_SELI_EXTRACT_4_OF_8_OFF_4);
...
#endif
const tFirFxdxns firdecf_2d_16m = { &firdecf_alloc_dx, firdecf_proc_D2_M16 };
