...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firdecf_proc_D2_MX,( complex_float * restrict y,
                   ...
                   int M, int N, int D )
{
    ...
    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        ...
        d0 = BBE_SELN_2XF32I(x1, x0, BBE_SELI_EXTRACT_4_OF_8_OFF_0);
        d1 = BBE_SELN_2XF32I(x1, x0, BBE_SELI_EXTRACT_4_OF_8_OFF_4);
        BBE_SVN_2XF32_X(d0, pD, 4 * 2 * M);
        BBE_SVN_2XF32_X(d1, pD, 4 * 2 * M + 2 * BBE_SIMD_WIDTH);
        ...
        for (m = 0; m < (M / (BBE_SIMD_WIDTH / 2)); m++)
        {
            ...
            x0 = d1;
            x1 = BBE_SELN_2XF32I(d2, d0, BBE_SELI_ROTATE_RIGHT_4);
            x2 = BBE_SELN_2XF32I(d3, d1, BBE_SELI_ROTATE_RIGHT_4);
            x3 = BBE_SELN_2XF32I(d2, d0, BBE_SELI_ROTATE_RIGHT_8);
            x4 = BBE_SELN_2XF32I(d3, d1, BBE_SELI_ROTATE_RIGHT_8);
            x5 = BBE_SELN_2XF32I(d2, d0, BBE_SELI_ROTATE_RIGHT_12);
            x6 = BBE_SELN_2XF32I(d3, d1, BBE_SELI_ROTATE_RIGHT_12);
            x7 = d2;
...
#endif
const tFirFxdxns firdecf_2d_xm = { &firdecf_alloc_d2_4_mx, firdecf_proc_D2_MX };
