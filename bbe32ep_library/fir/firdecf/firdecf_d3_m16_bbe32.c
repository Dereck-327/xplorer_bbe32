...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firdecf_proc_D3_M16,( complex_float * restrict y,
                   ...
                   int M, int N, int D )
{
    ...
    const xb_vecN_2xf32 * restrict pH = (const xb_vecN_2xf32 *)coef + 1;
    ...
    x0 = BBE_SELN_2XF32I(x0, d3, BBE_SELI_ROTATE_RIGHT_4);//r0,r1,r2,r3
    ...
    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        ...
        x6 = BBE_SELN_2XF32I(s0, d0, BBE_SELI_ROTATE_RIGHT_8);
        x7 = BBE_SELN_2XF32I(s1, d1, BBE_SELI_ROTATE_RIGHT_8);
    ...
    d3 = BBE_SELN_2XF32I(x0, x0, BBE_SELI_ROTATE_RIGHT_12);
...
#endif
const tFirFxdxns firdecf_3d_16m = { &firdecf_alloc_dx, firdecf_proc_D3_M16 };
