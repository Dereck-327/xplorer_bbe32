...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firdecf_proc_D4_M8,( complex_float * restrict y,
                   ...
                   int M, int N, int D )
{
    ...
    x0 = BBE_SELN_2XF32I(x0, d0, BBE_SELI_ROTATE_RIGHT_4);
    d2 = BBE_SELN_2XF32I(d3, d3, BBE_SELI_ROTATE_RIGHT_12);
    d1 = BBE_SELN_2XF32I(d3, d3, BBE_SELI_ROTATE_RIGHT_8);
    d0 = BBE_SELN_2XF32I(d3, d3, BBE_SELI_ROTATE_RIGHT_4);

    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        BBE_LVN_2XF32_IP(c0, pH, 0);
        ...
        BBE_DSELN_2XF32I(s2, s0, x2, x0, BBE_DSELI_INTERLEAVE_4);
        BBE_DSELN_2XF32I(s3, s1, x3, x1, BBE_DSELI_INTERLEAVE_4);
        BBE_DSELN_2XF32I(x5, x4, s1, s0, BBE_DSELI_INTERLEAVE_4);
        BBE_DSELN_2XF32I(x7, x6, s3, s2, BBE_DSELI_INTERLEAVE_4);
        x0 = BBE_SELN_2XF32I(x4, d0, BBE_SELI_ROTATE_RIGHT_12);
        x1 = BBE_SELN_2XF32I(x5, d1, BBE_SELI_ROTATE_RIGHT_12);
        x2 = BBE_SELN_2XF32I(x6, d2, BBE_SELI_ROTATE_RIGHT_12);
        x3 = BBE_SELN_2XF32I(x7, d3, BBE_SELI_ROTATE_RIGHT_12);
    ...
    d0 = BBE_SELN_2XF32I(x5, x4, BBE_SELI_INTERLEAVE_4_HI);
    d1 = BBE_SELN_2XF32I(x7, x6, BBE_SELI_INTERLEAVE_4_HI);
    d0 = BBE_SELN_2XF32I(d1, d0, BBE_SELI_EXTRACT_HI_HALVES);
...
#endif
const tFirFxdxns firdecf_4d_8m = { &firdecf_alloc_dx, firdecf_proc_D4_M8 };
