...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firdecf_proc_D2_M2,( complex_float * restrict y,
                   ...
                   int M, int N, int D )
{
    ...
    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        ...
        x1 = BBE_SELN_2XF32I(d2, d1, BBE_SELI_ROTATE_RIGHT_12);
...
#endif
const tFirFxdxns firdecf_2d_2m = { &firdecf_alloc_dx, firdecf_proc_D2_M2 };
