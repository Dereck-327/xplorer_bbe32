...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firdecf_proc_D3_M2,( complex_float * restrict y,
                   ...
                   int M, int N, int D )
{
    ...
    d0 = BBE_SELN_2XF32I(x0, d0, BBE_SELI_ROTATE_RIGHT_12);
    ...
    {
        BBE_LAN_2XF32_IP(d1, vx, pX);
        BBE_LAN_2XF32_IP(d2, vx, pX);

        d2 = BBE_SELN_2XF32I(d2, d2, BBE_SELI_ROTATE_RIGHT_4);
        x1 = BBE_SELN_2XF32I(d2, d1, BBE_SELI_ROTATE_RIGHT_8);
        d1 = BBE_SELN_2XF32I(d1, d0, BBE_SELI_ROTATE_RIGHT_12);
        x0 = BBE_SELN_2XF32I(d1, d0, BBE_SELI_EXTRACT_LO_HALVES);
        ...
        BBE_LAN_2XF32_IP(d0, vx, pX);
    }
    d0 = BBE_SELN_2XF32I(d0, d0, BBE_SELI_ROTATE_RIGHT_4);
    BBE_SVN_2XF32_I(d0, pD, 0);
}// firdecf_proc_D3_M2()
#endif
const tFirFxdxns firdecf_3d_2m = { &firdecf_alloc_dx, firdecf_proc_D3_M2 };
