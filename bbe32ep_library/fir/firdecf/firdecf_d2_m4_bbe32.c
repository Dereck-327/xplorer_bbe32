...
-------------------------------------------------------------------------*/
#if !HAVE_VFPU
DISCARD_FUN (void,firdecf_proc_D2_M4,( complex_float * restrict y,
                   ...
                   int M, int N, int D )
{
    ...
    x0 = BBE_LVN_2XF32_I(pD, 0);
    d0 = BBE_SELN_2XF32I(x0, x0, BBE_SELI_EXTRACT_LO_HALVES);
    d1 = BBE_SELN_2XF32I(x0, x0, BBE_SELI_EXTRACT_HI_HALVES);
    ...
    for (n = 0; n < N / (BBE_SIMD_WIDTH / 4); n++)
    {
        ...
        x0 = BBE_SELN_2XF32I(d3, d1, BBE_SELI_ROTATE_RIGHT_8);
        x1 = BBE_SELN_2XF32I(d2, d0, BBE_SELI_ROTATE_RIGHT_12);
        x2 = BBE_SELN_2XF32I(d3, d1, BBE_SELI_ROTATE_RIGHT_12);
        x3 = d2;

        y0 = BBE_MULN_2XF32(x0, h0);
        y1 = BBE_MULN_2XF32(x1, h1);
        BBE_MULAN_2XF32(y0, x2, h2);
        BBE_MULAN_2XF32(y1, x3, h3);
...
#endif
const tFirFxdxns firdecf_2d_4m = { &firdecf_alloc_dx, firdecf_proc_D2_M4 };
