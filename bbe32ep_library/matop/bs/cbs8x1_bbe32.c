...
/* M=8, N=1, Sx=8, Sy=8 */
void cbs8x1 (complex_fract16 * restrict y, const complex_fract16 * restrict x,int L)
{
  ...
  xb_vecNx16* restrict z5 = z3 + (L >> (LOG2_BBE_SIMD_WIDTH - 2));
  xb_vecNx16* restrict z6 = z4 + (L >> (LOG2_BBE_SIMD_WIDTH - 2));
  xb_vecNx16* restrict z7 = z5 + (L >> (LOG2_BBE_SIMD_WIDTH - 2));
