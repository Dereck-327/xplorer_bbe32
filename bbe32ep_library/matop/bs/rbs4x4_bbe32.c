...
/* M=4, N=4, Sx=16, Sy=16 */
void rbs4x4 ( int16_t * restrict y, const int16_t * restrict x, int L )
{
  ...
  for (k = 0; k<(L >> LOG2_BBE_SIMD_WIDTH); k++)
  {
    ...
    BBE_SVNX16_XP(Y8, Y, _2L);
    BBE_SVNX16_XP(Y9, Y, _2L);
    BBE_DSELNX16I(YB, YA, XD, X5, BBE_DSELI_DEINTERLEAVE_1);
    BBE_SVNX16_XP(YA, Y, _2L);
    BBE_SVNX16_XP(YB, Y, _2L);
    BBE_DSELNX16I(YD, YC, XE, X6, BBE_DSELI_DEINTERLEAVE_1);
    BBE_SVNX16_XP(YC, Y, _2L);
    BBE_SVNX16_XP(YD, Y, _2L);
    BBE_MOVVW(X0, X7, W0);
    BBE_DSELNX16I(YF, YE, XF, X7, BBE_DSELI_DEINTERLEAVE_1);
    BBE_SVNX16_XP(YE, Y, _2L);
    BBE_SVNX16_XP(YF, Y, back);
  }
} /* rbs4x4() */
