...
/* M=3 */
void cinterleave3 ( complex_fract16 * restrict y, const complex_fract16 * restrict x0, 
                                          ...
                                          const complex_fract16 * restrict x2, int N )
{
  ...
  for (n = 0; n<(N >> (LOG2_BBE_SIMD_WIDTH - 1)); n++)
  {
    ...
    BBE_DSELNX16I(Z1, Z0, X2, Y0, BBE_DSELI_INTERLEAVE_C3_STEP_0);
    BBE_DSELNX16I_H(Z1, Z2, X2, Y1, BBE_DSELI_INTERLEAVE_C3_STEP_1);
