...
#if !(HAVE_VFPU)
DISCARD_FUN(void, matvmul4x4sf,( float32_t * restrict z, 
              ...
              int L )
{
  ...
  const xb_vecN_2xf32 * restrict py3;
  ...
  px3 = (const xb_vecN_2xf32 *)(x+L*3);
  py0 = (const xb_vecN_2xf32 *)(y+L*0);
  py1 = (const xb_vecN_2xf32 *)(y+L*1);
  py2 = (const xb_vecN_2xf32 *)(y+L*2);
  py3 = (const xb_vecN_2xf32 *)(y+L*3);
  pz0 = (      xb_vecN_2xf32 *)(z);

  for (l = 0; l<(L>>(LOG2_BBE_SIMD_WIDTH-1)); l++)
  {
    /* Load input matrix X */
    BBE_LVN_2XF32_XP(x00, px0,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x01, px1,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x02, px2,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x03, px3,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x10, px0,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x11, px1,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x12, px2,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x13, px3,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x20, px0,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x21, px1,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x22, px2,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x23, px3,   4*L*sz_f32);
    BBE_LVN_2XF32_XP(x30, px0, -12*L*sz_f32+2*BBE_SIMD_WIDTH);
    BBE_LVN_2XF32_XP(x31, px1, -12*L*sz_f32+2*BBE_SIMD_WIDTH);
    BBE_LVN_2XF32_XP(x32, px2, -12*L*sz_f32+2*BBE_SIMD_WIDTH);
    BBE_LVN_2XF32_XP(x33, px3, -12*L*sz_f32+2*BBE_SIMD_WIDTH);

    /* Load input matrix Y */
    BBE_LVN_2XF32_IP(y0, py0, 2*BBE_SIMD_WIDTH);
    BBE_LVN_2XF32_IP(y1, py1, 2*BBE_SIMD_WIDTH);
    BBE_LVN_2XF32_IP(y2, py2, 2*BBE_SIMD_WIDTH);
    BBE_LVN_2XF32_IP(y3, py3, 2*BBE_SIMD_WIDTH);
    ...
    BBE_SVN_2XF32_XP(z2, pz0,    L*sz_f32);
    BBE_SVN_2XF32_XP(z3, pz0, -3*L*sz_f32+2*BBE_SIMD_WIDTH);
  }
} /* matvmul4x4sf() */
#endif
