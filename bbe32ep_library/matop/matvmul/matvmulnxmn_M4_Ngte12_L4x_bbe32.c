...
#if !(HAVE_MULPC && 1)
DISCARD_FUN(void, matvmulnxmn_M4_Ngte12_L4x, (void    *          pScr,
                   int16_t * restrict z, 
             const int16_t * restrict x, 
             const int16_t * restrict y, 
             int N, int M, int L, int Q ))
size_t matvmulnxmn_M4_Ngte12_getScratchSize(int N, int M) { (void)N; (void)M; return 0; }
#else
...
// M==4 && N>=12 && !(L&3)
void matvmulnxmn_M4_Ngte12_L4x( void    *          pScr,
                                int16_t * restrict z, 
                          const int16_t * restrict x, 
                          const int16_t * restrict y, 
                          int N, int M, int L, int Q )
...
} /* matvmulnxmn_M4_Ngte12_L4x() */
size_t matvmulnxmn_M4_Ngte12_getScratchSize(int N, int M)
{
  int Sx;
  Sx = getSpaceR(N*M);
  return (Sx * 2 * 4 + 4 * 4)*sizeof(int16_t);
} /* matvmulnxmn_M4_Ngte12_getScratchSize() */
#endif
