              ...
              int L, int Q )
{
  ...
  for (i = k = 0; k<L * 4; k++)
  {
    i = BBE_ADDMOD16U(i, 0x080002);    /*i=(i+2)&7;*/
    ...
    x_sel = BBE_REPNX16C(x1, 0); BBE_LVNX16_IP(y0, py, 2 * BBE_SIMD_WIDTH); acc = BBE_MULRNX16C(x_sel, y0, q);
    x_sel = BBE_REPNX16C(x1, 1); BBE_LVNX16_IP(y0, py, 2 * BBE_SIMD_WIDTH); BBE_MULANX16C(acc, x_sel, y0);
    x_sel = BBE_REPNX16C(x1, 2); BBE_LVNX16_IP(y0, py, 2 * BBE_SIMD_WIDTH); BBE_MULANX16C(acc, x_sel, y0);
    x_sel = BBE_REPNX16C(x1, 3); BBE_LVNX16_IP(y0, py, 2 * BBE_SIMD_WIDTH); BBE_MULANX16C(acc, x_sel, y0);
    x_sel = BBE_REPNX16C(x1, 4); BBE_LVNX16_IP(y0, py, 2 * BBE_SIMD_WIDTH); BBE_MULANX16C(acc, x_sel, y0);
    x_sel = BBE_REPNX16C(x1, 5); BBE_LVNX16_IP(y0, py, 2 * BBE_SIMD_WIDTH); BBE_MULANX16C(acc, x_sel, y0);
    x_sel = BBE_REPNX16C(x1, 6); BBE_LVNX16_IP(y0, py, 2 * BBE_SIMD_WIDTH); BBE_MULANX16C(acc, x_sel, y0);
    x_sel = BBE_REPNX16C(x1, 7); BBE_LVNX16_XP(y0, py, ystride); BBE_MULANX16C(acc, x_sel, y0);
    x0 = BBE_PACKVNX40(acc, q); BBE_SVNX16_IP(x0, pz, 2 * BBE_SIMD_WIDTH);
  }
} /* rcmatmul8x8n() */
