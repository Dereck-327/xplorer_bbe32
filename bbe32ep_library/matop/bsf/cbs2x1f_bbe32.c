...
/* M=2, N=1, Sx=2, Sy=2 */
void cbs2x1f ( complex_float * restrict y, const complex_float * restrict x, int L )
{
  ...
  py0 = (      xb_vecNx16 *)(y);
  py1 = (      xb_vecNx16 *)((complex_float *)py0+L);
  ...
  for (l = 0; l<(L>>(LOG2_BBE_SIMD_WIDTH-2)); l++)
  {
    ...
    Y0 = BBE_SELNX16I(X1, X0, BBE_SELI_EXTRACT_4_OF_8_OFF_0);
    Y1 = BBE_SELNX16I(X1, X0, BBE_SELI_EXTRACT_4_OF_8_OFF_4);
