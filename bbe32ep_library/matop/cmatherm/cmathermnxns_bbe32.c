...
/* Streaming Order, NxN*NxN->NxN, Sx=NxN, Sy=NxN
   Restrictions:
    ...
    for (i = 0; i < N - 1; i += 2) 
    {
      ...
      for (j = i + 1; j < N; j += 2) 
      {
        ...
        for (k = 0; k < L8; k++)
        {
          ...
          z_out00 = BBE_MULNX16J(y00, x00);
          z_out01 = BBE_MULNX16J(y00, x01);
          z_out10 = BBE_MULNX16J(y01, x00);
          z_out11 = BBE_MULNX16J(y01, x01);
