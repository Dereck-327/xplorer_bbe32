...
/* M=8, N=1, Sx=8, Sy=8 */
void rsb8x1 ( int16_t * restrict y, const int16_t * restrict x, int L )
{
  ...
  const xb_vecNx16* restrict z5 = z3 + (L >> 3);
  const xb_vecNx16* restrict z6 = z4 + (L >> 3);
  const xb_vecNx16* restrict z7 = z5 + (L >> 3);
