...
/* M=2, N=1, Sx=2, Sy=2 */
void rsb2x1 ( int16_t * restrict y, const int16_t * restrict x, int L )
{
  ...
  for (l = 0; l<(L >> LOG2_BBE_SIMD_WIDTH); l++)
  {
    ...
    y0 = BBE_SELNX16I(x1, x0, BBE_SELI_INTERLEAVE_1_LO);
    y1 = BBE_SELNX16I(x1, x0, BBE_SELI_INTERLEAVE_1_HI);
