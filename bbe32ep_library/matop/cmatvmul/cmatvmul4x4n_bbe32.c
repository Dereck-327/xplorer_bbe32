...
DISCARD_FUN(void, cmatvmul4x4n,(complex_fract16 * restrict z, 
              ...
              int L, int Q )
{
  ...
  for (l = 0; l<L; l += 2)
  {
    ...
    X = BBE_SELNX16I(X1, X0, BBE_SELI_EXTRACT_4_OF_8_OFF_0);
    Y = BBE_SHFLNX16I(Y0, BBE_SHFLI_MMC4X4X4X1_M1_STEP_1_LOW_HALF);
    r = BBE_MULRNX16PC_0(X, Y, q);
    X = BBE_SELNX16I(X1, X0, BBE_SELI_EXTRACT_4_OF_8_OFF_4);
    Y = BBE_SHFLNX16I(Y0, BBE_SHFLI_MMC1X4X4X4_M1_STEP_2_LOW_HALF);
    BBE_MULANX16PC_0(r, X, Y);
    /* Load 2-nd matrix */
    X1 =  BBE_LVNX16_I(px, 2 * BBE_SIMD_WIDTH);
    BBE_LVNX16_IP(X0, px, 2*2 * BBE_SIMD_WIDTH);

    X = BBE_SELNX16I(X1, X0, BBE_SELI_EXTRACT_4_OF_8_OFF_0);
    Y = BBE_SHFLNX16I(Y0, BBE_SHFLI_MMC1X4X4X4_M1_STEP_1_HIGH_HALF);
    BBE_MULANX16PC_1(r, X, Y);
    X = BBE_SELNX16I(X1, X0, BBE_SELI_EXTRACT_4_OF_8_OFF_4);
    Y = BBE_SHFLNX16I(Y0, BBE_SHFLI_MMC1X4X4X4_M1_STEP_2_HIGH_HALF);
    BBE_MULANX16PC_1(r, X, Y);

    /* Pack and save results */
    r = BBE_SHFLNX40I(r, BBE_W_SHFLI_DITLV_2);
    Z = BBE_PACKVNX40(r, q);
