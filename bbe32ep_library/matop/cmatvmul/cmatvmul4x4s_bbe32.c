              ...
              int L, int Q )
{
  ...
  {
    /* Loading input matrix X */
    BBE_LVNX16_XP(X00, X_, 2 * 2 * L);
    BBE_LVNX16_XP(X01, X_, 2 * 2 * L);
    BBE_LVNX16_XP(X02, X_, 2 * 2 * L);
    BBE_LVNX16_XP(X03, X_, 2 * 2 * L);

    /* Loading input vector Y */
    BBE_LVNX16_XP(Y0, Y_, 2 * 2 * L);
    BBE_LVNX16_XP(Y1, Y_, 2 * 2 * L);
    BBE_LVNX16_XP(Y2, Y_, 2 * 2 * L);
    BBE_LVNX16_XP(Y3, Y_, -3 * 2 * 2 * L + 2 * BBE_SIMD_WIDTH);

    /* Multiple input matrix X and Y */
    Z0 = BBE_MULNX16C(X00, Y0);
    BBE_MULANX16C(Z0, X01, Y1);
    BBE_MULANX16C(Z0, X02, Y2);
    BBE_MULANX16C(Z0, X03, Y3);
    ...
    /* Multiple input matrix X and Y */
    Z1 = BBE_MULNX16C(X00, Y0);
    BBE_MULANX16C(Z1, X01, Y1);
    BBE_MULANX16C(Z1, X02, Y2);
    BBE_MULANX16C(Z1, X03, Y3);

    /* Pack and save result */
    z0 = BBE_PACKVNX40(Z0, q);    z1 = BBE_PACKVNX40(Z1, q);
    BBE_SVNX16_XP(z0, Z_, 2 * 2 * L); BBE_SVNX16_XP(z1, Z_, 2 * 2 * L);
    ...
    BBE_LVNX16_XP(X01, X_, 2 * 2 * L);
    BBE_LVNX16_XP(X02, X_, 2 * 2 * L);
    BBE_LVNX16_XP(X03, X_, -15 * 2 * 2 * L + 2 * BBE_SIMD_WIDTH);
    ...
    /* Pack and save result */
    z0 = BBE_PACKVNX40(Z0, q);    z1 = BBE_PACKVNX40(Z1, q);
    BBE_SVNX16_XP(z0, Z_, 2 * 2 * L); BBE_SVNX16_XP(z1, Z_, -3 * 2 * 2 * L + 2 * BBE_SIMD_WIDTH);
  }
} /* cmatvmul4x4s() */
