...
#if !(HAVE_VFPU)
DISCARD_FUN(void, cmatmul4x4sf, ( complex_float * restrict z, 
              ...
              int L )
{
  ...
  for (l = 0; l<(L>>(LOG2_BBE_SIMD_WIDTH-2))*4; l++)
  {
    ...
    XT_MOVNEZ(stridexz, -3*L*sz_cf32+2*BBE_SIMD_WIDTH, k);
    stridey = -15*L*sz_cf32+2*BBE_SIMD_WIDTH;
    XT_MOVEQZ(stridey, -15*L*sz_cf32+2*BBE_SIMD_WIDTH-L*sz_cf32, k);
    ...
    BBE_LVN_4XCF32_XP(y03, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y10, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y11, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y12, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y13, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y20, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y21, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y22, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y23, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y30, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y31, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y32, py, L*sz_cf32);
    BBE_LVN_4XCF32_XP(y33, py, stridey);

    /* Compute 1 row of matrix Z */
    z00 = BBE_MULN_4XCF32(x00, y00);
    z01 = BBE_MULN_4XCF32(x00, y01);
    z02 = BBE_MULN_4XCF32(x00, y02);
    z03 = BBE_MULN_4XCF32(x00, y03);
    BBE_MULAN_4XCF32(z00, x01, y10);
    BBE_MULAN_4XCF32(z01, x01, y11);
    BBE_MULAN_4XCF32(z02, x01, y12);
    BBE_MULAN_4XCF32(z03, x01, y13);
    BBE_MULAN_4XCF32(z00, x02, y20);
    BBE_MULAN_4XCF32(z01, x02, y21);
    BBE_MULAN_4XCF32(z02, x02, y22);
    BBE_MULAN_4XCF32(z03, x02, y23);
    BBE_MULAN_4XCF32(z00, x03, y30);
    BBE_MULAN_4XCF32(z01, x03, y31);
    BBE_MULAN_4XCF32(z02, x03, y32);
    BBE_MULAN_4XCF32(z03, x03, y33);

    /* Save results (1 row) */
    BBE_SVN_4XCF32_XP(z00, pz, L*sz_cf32);
    BBE_SVN_4XCF32_XP(z01, pz, L*sz_cf32);
    BBE_SVN_4XCF32_XP(z02, pz, L*sz_cf32);
    BBE_SVN_4XCF32_XP(z03, pz, stridexz);
  }
} /* cmatmul4x4sf() */
#endif
