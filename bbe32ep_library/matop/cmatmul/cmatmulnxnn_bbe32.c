...
DISCARD_FUN(void, cmatmulnxnn,( void    *          pScr,
                  complex_fract16 * restrict z, 
            const complex_fract16 * restrict x, 
            const complex_fract16 * restrict y, 
            int N, int L, int Q ))
size_t cmatmulnxnn_getScratchSize(int N, int L) { (void)N; (void)L; return 0; }
#else
             ...
             int N, int L, int Q )
{
  ...
  cmatmulnxmn(pScr, z, x, y, N, N, L, Q);
} /* cmatmulnxnn() */

/* Return the scratch area size, in bytes. */
size_t cmatmulnxnn_getScratchSize ( int N, int L )
{
  return cmatmulnxmn_getScratchSize(N, N, L);
} /* cmatmulnxnn_getScratchSize() */
#endif
