             ...
             int L )
{
  ...
  for (i = 0; i<L; i++)
  {
    BBE_LVNX16_IP(a0, px, 2 * BBE_SIMD_WIDTH);
    BBE_LVNX16_IP(a1, px, 2 * BBE_SIMD_WIDTH);
    BBE_LVNX16_IP(a2, px, 2 * BBE_SIMD_WIDTH);
    BBE_LVNX16_IP(a3, px, 2 * BBE_SIMD_WIDTH);

    BBE_DSELNX16I(a1, a0, a1, a0, BBE_DSELI_DEINTERLEAVE_1);
    BBE_DSELNX16I(a3, a2, a3, a2, BBE_DSELI_DEINTERLEAVE_1);

    BBE_DSELNX16I(a2, a0, a2, a0, BBE_DSELI_DEINTERLEAVE_1);
    BBE_DSELNX16I(a3, a1, a3, a1, BBE_DSELI_DEINTERLEAVE_1);

    BBE_DSELNX16I(a1, a0, a1, a0, BBE_DSELI_DEINTERLEAVE_1);
    BBE_DSELNX16I(a3, a2, a3, a2, BBE_DSELI_DEINTERLEAVE_1);

    BBE_SVNX16_IP(a0, py, 2 * BBE_SIMD_WIDTH);
    BBE_SVNX16_IP(a2, py, 2 * BBE_SIMD_WIDTH);
    BBE_SVNX16_IP(a1, py, 2 * BBE_SIMD_WIDTH);
    BBE_SVNX16_IP(a3, py, 2 * BBE_SIMD_WIDTH);
  }
} /* mattran8x8n() */
