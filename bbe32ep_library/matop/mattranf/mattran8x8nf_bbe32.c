              ...
              int L )
{
  ...
  for (l=0; l<L; l++)
  {
    ...
    BBE_LVNX16_IP(X4, px1,   2*BBE_SIMD_WIDTH);
    BBE_LVNX16_IP(X5, px1,   2*BBE_SIMD_WIDTH);
    BBE_LVNX16_IP(X6, px1,   2*BBE_SIMD_WIDTH);
    BBE_LVNX16_IP(X7, px1, 5*2*BBE_SIMD_WIDTH);
    ...
    BBE_SVNX16_IP(Y4, py, 2*BBE_SIMD_WIDTH);
    BBE_SVNX16_IP(Y5, py, 2*BBE_SIMD_WIDTH);
    BBE_SVNX16_IP(Y6, py, 2*BBE_SIMD_WIDTH);
    BBE_SVNX16_IP(Y7, py, 2*BBE_SIMD_WIDTH);
  }
} /* mattran8x8nf() */
