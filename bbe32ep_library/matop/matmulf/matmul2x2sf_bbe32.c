...
#if !(HAVE_VFPU)
DISCARD_FUN(void, matmul2x2sf,( float32_t * restrict z, 
             ...
             int L )
{
  ...
  xb_vecN_2xf32 x00, x01, x10, x11;
  xb_vecN_2xf32 y00, y01, y10, y11;
  ...
  px0 = (const xb_vecN_2xf32 *)(x+L*2);
  px1 = (const xb_vecN_2xf32 *)(x+L*3);
  py0 = (const xb_vecN_2xf32 *)(y+L*1);
  py1 = (const xb_vecN_2xf32 *)(y+L*3);
  pz0 = (      xb_vecN_2xf32 *)(z+L*2);
  pz1 = (      xb_vecN_2xf32 *)(z+L*3);

  for (l = 0; l<(L>>(LOG2_BBE_SIMD_WIDTH-1)); l++)
  {
    /* Load input matrices X and Y */
    x00 = BBE_LVN_2XF32_X(px0, -2*L*sz_f32);
    x01 = BBE_LVN_2XF32_X(px1, -2*L*sz_f32);
    BBE_LVN_2XF32_IP(x10, px0, 2*BBE_SIMD_WIDTH);
    BBE_LVN_2XF32_IP(x11, px1, 2*BBE_SIMD_WIDTH);
    y00 = BBE_LVN_2XF32_X(py0, -L*sz_f32);
    BBE_LVN_2XF32_IP(y01, py0, 2*BBE_SIMD_WIDTH);
    y10 = BBE_LVN_2XF32_X(py1, -L*sz_f32);
    BBE_LVN_2XF32_IP(y11, py1, 2*BBE_SIMD_WIDTH);
    ...
    /* Save results */
    BBE_SVN_2XF32_X (z00, pz0, -2*L*sz_f32);
    BBE_SVN_2XF32_X (z01, pz1, -2*L*sz_f32);
    BBE_SVN_2XF32_IP(z10, pz0, 2*BBE_SIMD_WIDTH);
    BBE_SVN_2XF32_IP(z11, pz1, 2*BBE_SIMD_WIDTH);
  }
} /* matmul2x2sf() */
#endif
