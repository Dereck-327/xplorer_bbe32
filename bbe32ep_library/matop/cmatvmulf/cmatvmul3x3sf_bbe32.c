...
#if !(HAVE_VFPU)
DISCARD_FUN(void, cmatvmul3x3sf,( complex_float * restrict z, 
               ...
               int L )
{
  ...
  {
    /* Load input matrix X */
    BBE_LVN_4XCF32_XP(x00, px0,  3*L*sz_cf32);
    BBE_LVN_4XCF32_XP(x01, px1,  3*L*sz_cf32);
    BBE_LVN_4XCF32_XP(x02, px2,  3*L*sz_cf32);
    BBE_LVN_4XCF32_XP(x10, px0,  3*L*sz_cf32);
    BBE_LVN_4XCF32_XP(x11, px1,  3*L*sz_cf32);
    BBE_LVN_4XCF32_XP(x12, px2,  3*L*sz_cf32);
    BBE_LVN_4XCF32_XP(x20, px0, -6*L*sz_cf32+2*BBE_SIMD_WIDTH);
    BBE_LVN_4XCF32_XP(x21, px1, -6*L*sz_cf32+2*BBE_SIMD_WIDTH);
    BBE_LVN_4XCF32_XP(x22, px2, -6*L*sz_cf32+2*BBE_SIMD_WIDTH);
    ...
    z20 = BBE_MULMN_4XCF32( x20, y0, 0, 0x4);
    z21 = BBE_MULMN_4XCF32( x20, y0, 1, 0xB);
    ...
    BBE_MULMASN_4XCF32(z20, x21, y1, 0, 0x4);
    BBE_MULMASN_4XCF32(z21, x21, y1, 1, 0xB);
    ...
    BBE_MULMASN_4XCF32(z20, x22, y2, 0, 0x4);
    BBE_MULMASN_4XCF32(z21, x22, y2, 1, 0xB);
    z00 = BBE_ADDN_4XCF32(z00, z01);
    z10 = BBE_ADDN_4XCF32(z10, z11);
    z20 = BBE_ADDN_4XCF32(z20, z21);

    /* Save results */
    BBE_SVN_4XCF32_XP(z00, pz0,    L*sz_cf32);
    BBE_SVN_4XCF32_XP(z10, pz0,    L*sz_cf32);
    BBE_SVN_4XCF32_XP(z20, pz0, -2*L*sz_cf32+2*BBE_SIMD_WIDTH);
  }
} /* cmatvmul3x3sf() */
#endif
