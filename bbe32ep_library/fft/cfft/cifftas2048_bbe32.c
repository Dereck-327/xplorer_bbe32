...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cifftas2048, (complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Radix-2 inverse FFT on complex data, auto scaling
...
int cifftas2048 ( complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp )
{
  ...
  NASSERT_ALIGN32(y);
  NASSERT_ALIGN32(x);
  scaling = R1_DFT4_L64_16(fft2048_tw1, (int16_t*)x, (int16_t*)y, 2048, bexp);
  scaling += R2_DFT4xI4_U2(fft2048_tw2, (int16_t*)y, (int16_t*)x, 2048, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft2048_tw3, (int16_t*)x, (int16_t*)y, 2048, 16, BBE_RRANGE());
  scaling += R3_DFT4xIv_2U(fft2048_tw4, (int16_t*)y, (int16_t*)x, 2048, 64, BBE_RRANGE());
  scaling += R2_DFT8xIN_8((int16_t*)x, (int16_t*)y, 2048, BBE_RRANGE());
  return scaling;
} /* cifftas2048() */
#endif
