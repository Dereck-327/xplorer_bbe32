...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cifftas32768_norm, (complex_fract16 * restrict y, complex_fract16 * restrict x))
#else
/*-------------------------------------------------------------------------
Radix-2 inverse FFT on complex data, auto scaling
...
int cifftas32768_norm ( complex_fract16 * restrict y, complex_fract16 * restrict x           )
{
  ...
  NASSERT_ALIGN32(y);
  NASSERT_ALIGN32(x);
  scaling = R1_DFT4_L64_16_norm(fft32768_tw1, (int16_t*)x, (int16_t*)y, 32768);
  scaling += R2_DFT4xI4_U2(fft32768_tw2, (int16_t*)y, (int16_t*)x, 32768, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft32768_tw3, (int16_t*)x, (int16_t*)y, 32768, 16, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft32768_tw4, (int16_t*)y, (int16_t*)x, 32768, 64, BBE_RRANGE());
  scaling += R3_DFT4xIv_2U(fft32768_tw5, (int16_t*)x, (int16_t*)y, 32768, 256, BBE_RRANGE());
  scaling += R3_DFT4xIv_2U(fft32768_tw6, (int16_t*)y, (int16_t*)x, 32768, 1024, BBE_RRANGE());
  {
    // Clip scaling to (1+log2(N)) bits 
    int total_scaling;
    bexp = BBE_RRANGE();
