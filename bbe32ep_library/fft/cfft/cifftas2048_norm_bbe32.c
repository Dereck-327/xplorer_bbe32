...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cifftas2048_norm, (complex_fract16 * restrict y, complex_fract16 * restrict x))
#else
/*-------------------------------------------------------------------------
Radix-2 inverse FFT on complex data, auto scaling
...
int cifftas2048_norm ( complex_fract16 * restrict y, complex_fract16 * restrict x           )
{
  ...
  NASSERT_ALIGN32(y);
  NASSERT_ALIGN32(x);
  scaling = R1_DFT4_L64_16_norm(fft2048_tw1, (int16_t*)x, (int16_t*)y, 2048);
