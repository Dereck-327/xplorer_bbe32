...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cifftas4096, (complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Radix-2 inverse FFT on complex data, auto scaling
...
int cifftas4096 ( complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp )
{
  ...
  NASSERT_ALIGN32(y);
  NASSERT_ALIGN32(x);
  scaling = R1_DFT4_L64_16(fft4096_tw1, (int16_t*)x, (int16_t*)y, 4096, bexp);
  scaling += R2_DFT4xI4_U2(fft4096_tw2, (int16_t*)y, (int16_t*)x, 4096, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft4096_tw3, (int16_t*)x, (int16_t*)y, 4096, 16, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft4096_tw4, (int16_t*)y, (int16_t*)x, 4096, 64, BBE_RRANGE());
  scaling += R3_DFT4xIv_2U(fft4096_tw5, (int16_t*)x, (int16_t*)y, 4096, 256, BBE_RRANGE());
  scaling += R2_DFT4xIN_4((int16_t*)y, (int16_t*)y, 4096, BBE_RRANGE());
  return scaling;
} /* cifftas4096() */
#endif
