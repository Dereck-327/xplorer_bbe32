...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cifftas16384, (complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Radix-2 inverse FFT on complex data, auto scaling
...
int cifftas16384 ( complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp )
{
  ...
  NASSERT_ALIGN32(y);
  NASSERT_ALIGN32(x);
  scaling = R1_DFT4_L64_16(fft16384_tw1, (int16_t*)x, (int16_t*)y, 16384, bexp);
  scaling += R2_DFT4xI4_U2(fft16384_tw2, (int16_t*)y, (int16_t*)x, 16384, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft16384_tw3, (int16_t*)x, (int16_t*)y, 16384, 16, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft16384_tw4, (int16_t*)y, (int16_t*)x, 16384, 64, BBE_RRANGE());
  scaling += R3_DFT4xIv_2U(fft16384_tw5, (int16_t*)x, (int16_t*)y, 16384, 256, BBE_RRANGE());
  scaling += R3_DFT4xIv_2U(fft16384_tw6, (int16_t*)y, (int16_t*)x, 16384, 1024, BBE_RRANGE());
