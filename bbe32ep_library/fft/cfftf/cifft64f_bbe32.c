...
DISCARD_FUN(int, cifft64f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cifft64f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_iDFT4_FP((const complex_float*)cfftf64_twd1, x, y, 64);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf64_twd2, y, x, 64, 4);
    stage_last_iDFT4xIN_4_FP(x, y, 64);
    return 0;
}
