...
DISCARD_FUN(int, cfft32f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cfft32f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_DFT4_FP_v2((const complex_float*)cfftf32_twd1, x, y, 32);
    stage_last_DFT8xIN_8_FP(y, y, 32);
