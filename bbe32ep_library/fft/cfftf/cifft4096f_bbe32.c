...
DISCARD_FUN(int, cifft4096f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cifft4096f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_iDFT4_FP((const complex_float*)cfftf4096_twd1, x, y, 4096);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf4096_twd2, y, x, 4096, 4);
    stage_inner_merged_iDFT4_FP((const complex_float*)cfftf4096_twd3, x, y, 4096, 16);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf4096_twd4, y, x, 4096, 64);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf4096_twd5, x, y, 4096, 256);
    stage_last_iDFT4xIN_4_FP(y, y, 4096);
    return 0;
}
