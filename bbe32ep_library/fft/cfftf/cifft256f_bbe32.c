...
DISCARD_FUN(int, cifft256f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cifft256f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_iDFT4_FP_v2((const complex_float*)cfftf256_twd1, x, y, 256);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf256_twd2, y, x, 256, 4);
    stage_inner_merged_iDFT4_FP((const complex_float*)cfftf256_twd3, x, y, 256, 16);
    stage_last_iDFT4xIN_4_FP(y, y, 256);
