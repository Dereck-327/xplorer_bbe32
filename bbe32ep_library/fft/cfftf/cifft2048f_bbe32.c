...
DISCARD_FUN(int, cifft2048f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cifft2048f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_iDFT4_FP_v2((const complex_float*)cfftf2048_twd1, x, y, 2048);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf2048_twd2, y, x, 2048, 4);
    stage_inner_merged_iDFT4_FP((const complex_float*)cfftf2048_twd3, x, y, 2048, 16);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf2048_twd4, y, x, 2048, 64);
    stage_last_iDFT8xIN_8_FP(x, y, 2048);
    return 0;
}
