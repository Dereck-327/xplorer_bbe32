...
DISCARD_FUN(int, cifft1024f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cifft1024f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_iDFT4_FP_v2((const complex_float*)cfftf1024_twd1, x, y, 1024);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf1024_twd2, y, x, 1024, 4);
    stage_inner_merged_iDFT4_FP((const complex_float*)cfftf1024_twd3, x, y, 1024, 16);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf1024_twd4, y, x, 1024, 64);
    stage_last_iDFT4xIN_4_FP(x, y, 1024);
