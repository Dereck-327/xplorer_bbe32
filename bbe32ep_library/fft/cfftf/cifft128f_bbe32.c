...
DISCARD_FUN(int, cifft128f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cifft128f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_iDFT4_FP_v2((const complex_float*)cfftf128_twd1, x, y, 128);
    stage_inner_R3_iDFT4xIv_FP((const complex_float*)cfftf128_twd2, y, x, 128, 4);
    stage_last_iDFT8xIN_8_FP(x, y, 128);
    return 0;
}
