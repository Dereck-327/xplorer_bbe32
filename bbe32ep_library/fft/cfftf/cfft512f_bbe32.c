...
DISCARD_FUN(int, cfft512f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cfft512f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_DFT4_FP_v2((const complex_float*)cfftf512_twd1, x, y, 512);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf512_twd2, y, x, 512, 4);
    stage_inner_merged_DFT4_FP((const complex_float*)cfftf512_twd3, x, y, 512, 16);
    stage_last_DFT8xIN_8_FP(y, y, 512);
