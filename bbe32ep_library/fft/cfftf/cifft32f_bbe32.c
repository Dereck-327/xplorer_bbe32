...
DISCARD_FUN(int, cifft32f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cifft32f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    NASSERT(x != y);
    first_stage_iDFT4_FP_v2((const complex_float*)cfftf32_twd1, x, y, 32);;
    stage_last_iDFT8xIN_8_FP(y, y, 32);
    return 0;
}
