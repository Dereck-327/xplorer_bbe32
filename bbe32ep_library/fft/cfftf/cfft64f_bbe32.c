...
DISCARD_FUN(int, cfft64f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cfft64f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_DFT4_FP((const complex_float*)cfftf64_twd1, x, y, 64);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf64_twd2, y, x, 64, 4);
    stage_last_DFT4xIN_4_FP(x, y, 64);
    return 0;
}
