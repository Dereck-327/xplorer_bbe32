...
DISCARD_FUN(int, cfft128f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cfft128f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_DFT4_FP_v2((const complex_float*)cfftf128_twd1, x, y, 128);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf128_twd2, y, x, 128, 4);
    stage_last_DFT8xIN_8_FP(x, y, 128);
