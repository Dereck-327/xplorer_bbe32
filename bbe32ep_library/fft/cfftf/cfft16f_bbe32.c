...
DISCARD_FUN(int, cfft16f, (complex_float * restrict y, complex_float * restrict x) )
#else
int cfft16f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    first_stage_DFT4_FP((const complex_float*)cfftf16_twd1, x/*(complex_float*)test_x*/, y, 16);
    stage_last_DFT4xIN_4_FP(y, y, 16);
    return 0;
}
