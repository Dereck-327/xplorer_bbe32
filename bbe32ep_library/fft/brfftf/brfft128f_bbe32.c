...
DISCARD_FUN(void, brfft128f, (complex_float * restrict y, float32_t * restrict x, int L) )
#else
void brfft128f(complex_float * restrict y, float32_t * restrict x, int L)
{
    ...
    bcfft64f(y, (complex_float*)x, L);
    blkrfft_spec_conv_packed_fp(y, twiddle_table, 128, L);
}
