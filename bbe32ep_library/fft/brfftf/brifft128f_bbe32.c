...
DISCARD_FUN(void, brifft128f, (float32_t * restrict y, complex_float * restrict x, int L) )
#else
void brifft128f(float32_t * restrict y, complex_float * restrict x, int L)
{

    complex_float *twiddle_table = (complex_float*)rfftf128_twd1;
    ...
    blkrifft_spec_conv_packed_fp(x, twiddle_table, 128, L);
    bcifft64f((complex_float*)y, x, L);
}
