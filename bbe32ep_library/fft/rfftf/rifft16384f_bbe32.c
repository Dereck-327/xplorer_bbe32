...
DISCARD_FUN(int, rifft16384f, (float32_t * restrict y, complex_float * restrict x) )
#else
int rifft16384f(float32_t * restrict y, complex_float * restrict x)
{
    const complex_float *twiddle_table = (const complex_float*)rfftf16384_twd1;
    ...
    rifft_spec_conv_fp(x, twiddle_table, 16384);
    cifft8192f((complex_float*)y, x);
    return 0;
}
