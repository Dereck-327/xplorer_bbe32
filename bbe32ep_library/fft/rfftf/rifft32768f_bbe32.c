...
DISCARD_FUN(int, rifft32768f, (float32_t * restrict y, complex_float * restrict x) )
#else
int rifft32768f(float32_t * restrict y, complex_float * restrict x)
{
    const complex_float *twiddle_table = (const complex_float*)rfftf32768_twd1;
    ...
    rifft_spec_conv_fp(x, twiddle_table, 32768);
    cifft16384f((complex_float*)y, x);
    return 0;
}
