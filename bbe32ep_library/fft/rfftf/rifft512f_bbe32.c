...
DISCARD_FUN(int, rifft512f, (float32_t * restrict y, complex_float * restrict x) )
#else
int rifft512f(float32_t * restrict y, complex_float * restrict x)
{
    const complex_float *twiddle_table = (const complex_float*)rfftf512_twd1;
    ...
    rifft_spec_conv_fp(x, twiddle_table, 512);
    cifft256f((complex_float*)y, x);
    return 0;
}
