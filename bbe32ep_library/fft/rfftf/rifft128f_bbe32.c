...
DISCARD_FUN(int, rifft128f, (float32_t * restrict y, complex_float * restrict x) )
#else
int rifft128f(float32_t * restrict y, complex_float * restrict x)
{
    const complex_float *twiddle_table = (const complex_float*)rfftf128_twd1;
    ...
    rifft_spec_conv_fp(x, twiddle_table, 128);
    cifft64f((complex_float*)y, x);
    return 0;
}
