...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft768, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft768 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16(fft768_tw1, (int16_t*)x, (int16_t*)pScr, 768, bexp);
  scaling += R2_DFT6xI4(fft768_tw2, (int16_t*)pScr, (int16_t*)y, 768, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft768_tw3, (int16_t*)y, (int16_t*)x, 768, 24, BBE_RRANGE());
  scaling += R2_DFT8xIN_8((int16_t*)x, (int16_t*)y, 768, BBE_RRANGE());
