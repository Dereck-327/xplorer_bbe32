...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft180, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft180 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft180_tw1, (int16_t*)x, (int16_t*)pScr, 180, bexp);
  scaling += R2_DFT5xI4_expand56(fft180_tw2, (int16_t*)pScr, (int16_t*)y, 180, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft180_tw4, (int16_t*)y, (int16_t*)x, 180 * 6 / 5, 24, BBE_RRANGE());
  scaling += R2_DFT3xIN_3_compress65((int16_t*)x, (int16_t*)y, 180 * 6 / 5, BBE_RRANGE());
