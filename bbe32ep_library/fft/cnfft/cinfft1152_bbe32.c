...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft1152, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft1152 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16(fft1152_tw1, (int16_t*)x, (int16_t*)y, 1152, bexp);
  scaling += R2_DFT4xI4(fft1152_tw2, (int16_t*)y, (int16_t*)x, 1152, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft1152_tw3, (int16_t*)x, (int16_t*)y, 1152, 16, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft1152_tw4, (int16_t*)y, (int16_t*)x, 1152, 48, BBE_RRANGE());
  scaling += R2_DFT8xIN_8((int16_t*)x, (int16_t*)y, 1152, BBE_RRANGE());
  return scaling;
} /* cinfft1152() */
#endif
