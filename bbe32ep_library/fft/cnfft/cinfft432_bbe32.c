...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft432, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft432 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N16(fft432_tw1, (int16_t*)x, (int16_t*)y, 432, bexp);
  scaling += R2_DFT4xI4_N16(fft432_tw2, (int16_t*)y, (int16_t*)x, 432, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft432_tw3, (int16_t*)x, (int16_t*)y, 432, 16, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft432_tw4, (int16_t*)y, (int16_t*)x, 432, 48, BBE_RRANGE());
  scaling += R2_DFT3xIN_3((int16_t*)x, (int16_t*)y, 432, BBE_RRANGE());
  return scaling;
} /* cinfft432() */
#endif
