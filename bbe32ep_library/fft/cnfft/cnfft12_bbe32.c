...
int cnfft12 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  tmp = BBE_REPNX16C(x0, 0);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); acc0 = BBE_MULRNX16C(tmp, w, s);
  tmp = BBE_REPNX16C(x0, 1);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
  tmp = BBE_REPNX16C(x0, 2);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
  tmp = BBE_REPNX16C(x0, 3);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);

  tmp = BBE_REPNX16C(x0, 4);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
  tmp = BBE_REPNX16C(x0, 5);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
  tmp = BBE_REPNX16C(x0, 6);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
  tmp = BBE_REPNX16C(x0, 7);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);

  tmp = BBE_REPNX16C(x1, 0);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
  tmp = BBE_REPNX16C(x1, 1);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
  tmp = BBE_REPNX16C(x1, 2);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
  tmp = BBE_REPNX16C(x1, 3);  BBE_LVNX16_IP(w, pw, BBE_SIMD_WIDTH * 2); BBE_MULANX16C(acc0, tmp, w);
