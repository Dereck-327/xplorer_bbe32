...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft24, (void * restrict pScr, complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft24 ( void * restrict pScr, complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp )
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft24_tw1, (int16_t*)x, (int16_t*)y, 24, bexp);
  scaling += R2_DFT2xI4_N8(fft24_tw2, (int16_t*)y, (int16_t*)x, 24, BBE_RRANGE());
  scaling += R2_DFT3xIN_3((int16_t*)x, (int16_t*)y, 24, BBE_RRANGE());
  return scaling;
} /* cinfft24() */
#endif
