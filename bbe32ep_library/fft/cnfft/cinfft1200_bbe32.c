...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft1200,  (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft1200 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N16(fft1200_tw1, (int16_t*)x, (int16_t*)y, 1200, bexp);
  scaling += R2_DFT4xI4_N16(fft1200_tw2, (int16_t*)y, (int16_t*)x, 1200, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft1200_tw3, (int16_t*)x, (int16_t*)y, 1200, 16, BBE_RRANGE());
  scaling += R3_DFT5xIv(fft1200_tw4, (int16_t*)y, (int16_t*)x, 1200, 48, BBE_RRANGE());
  scaling += R2_DFT5xIN_5((int16_t*)x, (int16_t*)y, 1200, BBE_RRANGE());
  return scaling;
} /* cinfft1200() */
#endif
