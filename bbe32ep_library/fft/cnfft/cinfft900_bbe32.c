...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft900, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft900 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft900_tw1, (int16_t*)x, (int16_t*)y, 900, bexp);
  scaling += R2_DFT5xI4_expand56(fft900_tw2, (int16_t*)y, (int16_t*)x, 900, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft900_tw4, (int16_t*)x, (int16_t*)y, 900 * 6 / 5, 24, BBE_RRANGE());
  scaling += R3_DFT5xI3xIv(fft900_tw5, (int16_t*)y, (int16_t*)x, 900 * 6 / 5, 72, BBE_RRANGE());
  scaling += R2_DFT3xIN_3_compress65((int16_t*)x,(int16_t*) y, 900 * 6 / 5, BBE_RRANGE());
  return scaling;
} /* cinfft900() */
#endif
