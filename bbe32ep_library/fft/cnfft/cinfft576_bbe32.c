...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft576, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft576 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16(fft576_tw1, (int16_t*)x, (int16_t*)y, 576, bexp);
  scaling += R2_DFT6xI4(fft576_tw2, (int16_t*)y, (int16_t*)x, 576, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft576_tw3, (int16_t*)x, (int16_t*)y, 576, 24, BBE_RRANGE());
  scaling += R2_DFT8xIN_8((int16_t*)y, (int16_t*)y, 576, BBE_RRANGE());
