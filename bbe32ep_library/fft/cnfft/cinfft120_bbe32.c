...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft120, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft120 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft120_tw1, (int16_t*)x, (int16_t*)y, 120, bexp);                                                                   //  scaling += R2_DFT2xI4_N8(fft120_tw2, y, x, 120, BBE_RRANGE()); 
  scaling += R2_DFT6xI4_N8(fft120_tw2, (int16_t*)y, (int16_t*)x, 120, BBE_RRANGE());    //scaling += R3_DFT3xIv(fft120_tw3, x, y, 120, 8, BBE_RRANGE()); 
  scaling += R2_DFT5xIN_5_unroll_all((int16_t*)x, (int16_t*)y, 120, BBE_RRANGE());
  return scaling;
} /* cinfft120() */
#endif
