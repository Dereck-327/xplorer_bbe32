...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft216, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft216 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft216_tw1, (int16_t*)x, (int16_t*)y, 216, bexp);
  scaling += R2_DFT6xI4_N8(fft216_tw2, (int16_t*)y, (int16_t*)x, 216, BBE_RRANGE());
  scaling += R2_DFT9xIN_9((int16_t*)x, (int16_t*)y, 216, BBE_RRANGE());
