...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft72, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft72 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft72_tw1, (int16_t*)x, (int16_t*)y, 72, bexp);
  scaling += R2_DFT6xI4_N8(fft72_tw2, (int16_t*)y, (int16_t*)x, 72, BBE_RRANGE());
  scaling += R2_DFT3xIN_3((int16_t*)x, (int16_t*)y, 72, BBE_RRANGE());
  return scaling;
} /* cinfft72() */
#endif
