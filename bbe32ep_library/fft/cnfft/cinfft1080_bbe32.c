...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft1080, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft1080 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft1080_tw1, (int16_t*)x, (int16_t*)y, 1080, bexp);
  scaling += R2_DFT6xI4_N8(fft1080_tw2, (int16_t*)y, (int16_t*)x, 1080, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft1080_tw3, (int16_t*)x, (int16_t*)y, 1080, 24, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft1080_tw4, (int16_t*)y, (int16_t*)x, 1080, 72, BBE_RRANGE());
  scaling += R2_DFT5xIN_5((int16_t*)x, (int16_t*)y, 1080, BBE_RRANGE());
