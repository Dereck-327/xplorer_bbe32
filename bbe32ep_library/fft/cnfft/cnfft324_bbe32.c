...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cnfft324, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix forward FFT on complex data, auto scaling
...
int cnfft324 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft324_tw1, (int16_t*)x, (int16_t*)y, 324, bexp);
  scaling += R2_DFT3xI4_expand(fft324_tw2, (int16_t*)y, (int16_t*)x, 324, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft324_tw4, (int16_t*)x, (int16_t*)y, 324 * 4 / 3, 16, BBE_RRANGE());
  scaling += R3_I3xDFT3xIv(fft324_tw5, (int16_t*)y, (int16_t*)x, 324 * 4 / 3, 48, BBE_RRANGE());
  scaling += R2_DFT3xIN_3_compress((int16_t*)x, (int16_t*)y, 324 * 4 / 3, BBE_RRANGE());
  return scaling;
} /* cnfft324() */
#endif
