...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft288, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft288 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16(fft288_tw1, (int16_t*)x, (int16_t*)y, 288, bexp);
  scaling += R2_DFT4xI4(fft288_tw2, (int16_t*)y, (int16_t*)x, 288, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft288_tw3, (int16_t*)x, (int16_t*)y, 288, 16, BBE_RRANGE());
  scaling += R2_DFT6xIN_6((int16_t*)y, (int16_t*)y, 288, BBE_RRANGE());
