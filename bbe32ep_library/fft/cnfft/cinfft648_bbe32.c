...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft648, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft648 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft648_tw1, (int16_t*)x, (int16_t*)pScr, 648, bexp);
  scaling += R2_DFT6xI4_N8(fft648_tw2, (int16_t*)pScr, (int16_t*)y, 648, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft648_tw3, (int16_t*)y, (int16_t*)x, 648, 24, BBE_RRANGE());
  scaling += R2_DFT9xIN_9((int16_t*)x, (int16_t*)y, 648, BBE_RRANGE());
  return scaling;
} /* cinfft648() */
#endif
