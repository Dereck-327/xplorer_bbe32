...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft972, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft972 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft972_tw1, (int16_t*)x, (int16_t*)pScr, 972, bexp);
  scaling += R2_DFT3xI4_expand(fft972_tw2, (int16_t*)pScr, (int16_t*)y, 972, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft972_tw4, (int16_t*)y, (int16_t*)x, 972 * 4 / 3, 16, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft972_tw5, (int16_t*)x, (int16_t*)y, 972 * 4 / 3, 48, BBE_RRANGE());
  scaling += R3_I3xDFT3xIv(fft972_tw6, (int16_t*)y, (int16_t*)x, 972 * 4 / 3, 144, BBE_RRANGE());
  scaling += R2_DFT3xIN_3_compress((int16_t*)x, (int16_t*)y, 972 * 4 / 3, BBE_RRANGE());
  return scaling;
} /* cinfft972() */
#endif
