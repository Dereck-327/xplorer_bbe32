...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft600, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft600 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft600_tw1, (int16_t*)x, (int16_t*)y, 600, bexp);
  scaling += R2_DFT6xI4_N8(fft600_tw2, (int16_t*)y, (int16_t*)x, 600, BBE_RRANGE());
  scaling += R3_DFT5xIv(fft600_tw3, (int16_t*)x, (int16_t*)y, 600, 24, BBE_RRANGE());
  scaling += R2_DFT5xIN_5((int16_t*)y, (int16_t*)y, 600, BBE_RRANGE());
