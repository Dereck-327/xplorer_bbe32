...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft480, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft480 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16(fft480_tw1, (int16_t*)x, (int16_t*)y, 480, bexp);
  scaling += R2_DFT6xI4(fft480_tw2, (int16_t*)y, (int16_t*)x, 480, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft480_tw3, (int16_t*)x, (int16_t*)y, 480, 24, BBE_RRANGE());
  scaling += R2_DFT5xIN_5((int16_t*)y, (int16_t*)y, 480, BBE_RRANGE());
  return scaling;
} /* cinfft480() */
#endif
