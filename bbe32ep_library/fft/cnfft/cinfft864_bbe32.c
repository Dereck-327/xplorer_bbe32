...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft864, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft864 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16(fft864_tw1, (int16_t*)x, (int16_t*)y, 864, bexp);
  scaling += R2_DFT6xI4(fft864_tw2, (int16_t*)y, (int16_t*)x, 864, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft864_tw3, (int16_t*)x, (int16_t*)y, 864, 24, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft864_tw4, (int16_t*)y, (int16_t*)x, 864, 96, BBE_RRANGE());
  scaling += R2_DFT3xIN_3((int16_t*)x, (int16_t*)y, 864, BBE_RRANGE());
  return scaling;
} /* cinfft864() */
#endif
