...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft960, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft960 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16(fft960_tw1, (int16_t*)x, (int16_t*)y, 960, bexp);
  scaling += R2_DFT4xI4(fft960_tw2, (int16_t*)y, (int16_t*)x, 960, BBE_RRANGE());
  scaling += R3_DFT4xIv(fft960_tw3, (int16_t*)x, (int16_t*)y, 960, 16, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft960_tw4, (int16_t*)y, (int16_t*)x, 960, 64, BBE_RRANGE());
  scaling += R2_DFT5xIN_5((int16_t*)x, (int16_t*)y, 960, BBE_RRANGE());
  return scaling;
} /* cinfft960() */
#endif
