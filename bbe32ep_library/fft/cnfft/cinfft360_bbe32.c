...
#if !(HAVE_FFT && 1)
DISCARD_FUN(int, cinfft360, (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp))
#else
/*-------------------------------------------------------------------------
Mixed radix inverse FFT on complex data, auto scaling
...
int cinfft360 (void * restrict pScr,complex_fract16 * restrict y, complex_fract16 * restrict x, int bexp)
{
  ...
  scaling = R1_DFT4_L64_16_N4(fft360_tw1, (int16_t*)x, (int16_t*)y, 360, bexp);
  scaling += R2_DFT6xI4_N8(fft360_tw2, (int16_t*)y, (int16_t*)x, 360, BBE_RRANGE());
  scaling += R3_DFT3xIv(fft360_tw3, (int16_t*)x, (int16_t*)y, 360, 24, BBE_RRANGE());
  scaling += R2_DFT5xIN_5((int16_t*)y, (int16_t*)y, 360, BBE_RRANGE());
  return scaling;
} /* cinfft360() */
#endif
