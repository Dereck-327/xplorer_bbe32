...
DISCARD_FUN(int, tfft16384f, (complex_float * restrict y, complex_float * restrict x) )
#else
int tfft16384f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    stage_first_tfft_DFT4_FP((const complex_float*)tfftf16384_twd1, x, y, 16384);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf16384_twd2, y, x, 16384, 4);
    stage_inner_DFT4_v16_FP((const complex_float*)cfftf16384_twd3, x, y, 16384, 16);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf16384_twd4, y, x, 16384, 64);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf16384_twd5, x, y, 16384, 256);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf16384_twd6, y, x, 16384, 1024);
    stage_last_DFT4xIN_4_FP(x, y, 16384);
    return 0;
}
