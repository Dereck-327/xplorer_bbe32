...
DISCARD_FUN(int, tfft8192f, (complex_float * restrict y, complex_float * restrict x) )
#else
int tfft8192f(complex_float * restrict y, complex_float * restrict x)
{
    ...
    stage_first_tfft_DFT4_FP((const complex_float*)tfftf8192_twd1, x, y, 8192);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf8192_twd2, y, x, 8192, 4);
    stage_inner_merged_DFT4_FP((const complex_float*)cfftf8192_twd3, x, y, 8192, 16);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf8192_twd4, y, x, 8192, 64);
    stage_inner_R3_DFT4xIv_FP((const complex_float*)cfftf8192_twd5, x, y, 8192, 256);
    stage_last_DFT8xIN_8_FP(y, y, 8192);
