...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcfft32, (complex_fract16 * restrict y, complex_fract16 * restrict x, int L))
#else
...
void bcfft32 ( complex_fract16 * restrict y, complex_fract16 * restrict x, int L )
{
  ...
  for (l = 0; l<L; l++)
  {
    ...
    b1 = BBE_MULNX16CPACKQ(b1, tw_T32_8_1);
    b2 = BBE_MULNX16CPACKQ(b2, tw_T32_8_2);
    b3 = BBE_MULNX16CPACKQ(b3, tw_T32_8_3);
    ...
    a1 = BBE_MULNX16CPACKQ(a1, tw_T8_2_1);
    a2 = BBE_MULNX16CPACKQ(a2, tw_T8_2_2);
    a3 = BBE_MULNX16CPACKQ(a3, tw_T8_2_3);
