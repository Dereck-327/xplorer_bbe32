...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcifft128, (complex_fract16 * restrict y, complex_fract16 * restrict x, int L))
#else
/*-------------------------------------------------------------------------
Blockwise radix-2 inverse FFT on complex data, no data scaling
...
void bcifft128 ( complex_fract16 * restrict y, complex_fract16 * restrict x, int L )
{
...

  {
...

    {
      ...
      b03 = BBE_FFTADD4SABNX16(a00, a01, 1, 0);
      b13 = BBE_FFTADD4SCDNX16(a10, a11, 1, 0);
      b02 = BBE_FFTADD4SABNX16(a00, a01, 2, 0);
      b12 = BBE_FFTADD4SCDNX16(a10, a11, 2, 0);
      b01 = BBE_FFTADD4SABNX16(a00, a01, 3, 0);
      b11 = BBE_FFTADD4SCDNX16(a10, a11, 3, 0);
      ...
      b23 = BBE_FFTADD4SABNX16(a20, a21, 1, 0);
      b33 = BBE_FFTADD4SCDNX16(a30, a31, 1, 0);
      b22 = BBE_FFTADD4SABNX16(a20, a21, 2, 0);
      b32 = BBE_FFTADD4SCDNX16(a30, a31, 2, 0);
      b21 = BBE_FFTADD4SABNX16(a20, a21, 3, 0);
      b31 = BBE_FFTADD4SCDNX16(a30, a31, 3, 0);

      //
      // ( L16_4 x I8 )*T128_32*( L16_4 x I8 )
      //

      b01 = BBE_MULNX16JPACKQ(b01, T128_32_0);
      b02 = BBE_MULNX16JPACKQ(b02, T128_32_1);
      b03 = BBE_MULNX16JPACKQ(b03, T128_32_2);

      b11 = BBE_MULNX16JPACKQ(b11, T128_32_3);
      b12 = BBE_MULNX16JPACKQ(b12, T128_32_4);
      b13 = BBE_MULNX16JPACKQ(b13, T128_32_5);

      b21 = BBE_MULNX16JPACKQ(b21, T128_32_6);
      b22 = BBE_MULNX16JPACKQ(b22, T128_32_7);
      b23 = BBE_MULNX16JPACKQ(b23, T128_32_8);

      b31 = BBE_MULNX16JPACKQ(b31, T128_32_9);
      b32 = BBE_MULNX16JPACKQ(b32, T128_32_10);
      b33 = BBE_MULNX16JPACKQ(b33, T128_32_11);
...

  {
...

    {
      ...
      b01 = BBE_MULNX16JPACKQ(b01, tw01);
      b02 = BBE_MULNX16JPACKQ(b02, tw02);
      b03 = BBE_MULNX16JPACKQ(b03, tw03);

      b11 = BBE_MULNX16JPACKQ(b11, tw11);
      b12 = BBE_MULNX16JPACKQ(b12, tw12);
      b13 = BBE_MULNX16JPACKQ(b13, tw13);

      b21 = BBE_MULNX16JPACKQ(b21, tw21);
      b22 = BBE_MULNX16JPACKQ(b22, tw22);
      b23 = BBE_MULNX16JPACKQ(b23, tw23);

      b31 = BBE_MULNX16JPACKQ(b31, tw31);
      b32 = BBE_MULNX16JPACKQ(b32, tw32);
      b33 = BBE_MULNX16JPACKQ(b33, tw33);
...

  {
    ...
    for (l = 0; l<L; l++)
    {
      ...
      a12 = BBE_MULNX16JPACKQ(a12, T8_2_1);
      a13 = BBE_MULNX16JPACKQ(a13, T8_2_1);
      a22 = BBE_MULNX16JPACKQ(a22, T8_2_2);
      a23 = BBE_MULNX16JPACKQ(a23, T8_2_2);
      // a32 and a33 are implicitly negated to reuse the T8_2_1 twiddle factor.
      a32 = BBE_MULNX16CPACKQ(a32, T8_2_1);
      a33 = BBE_MULNX16CPACKQ(a33, T8_2_1);
