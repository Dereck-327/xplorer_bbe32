...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcfft64, (complex_fract16 * restrict y, complex_fract16 * restrict x, int L))
#else
...
void bcfft64 ( complex_fract16 * restrict y, complex_fract16 * restrict x, int L )
{
  ...
  for (l = 0; l<L; l++)
  {
    ...
    b10 = BBE_FFTADD4SABNX16(a00, a10, 1, 0);
    b11 = BBE_FFTADD4SCDNX16(a01, a11, 1, 0);
    b20 = BBE_FFTADD4SABNX16(a00, a10, 2, 0);
    b21 = BBE_FFTADD4SCDNX16(a01, a11, 2, 0);
    b30 = BBE_FFTADD4SABNX16(a00, a10, 3, 0);
    b31 = BBE_FFTADD4SCDNX16(a01, a11, 3, 0);

    //
    // T64_16
    //

    b10 = BBE_MULNX16CPACKQ(b10, T64_16_10);
    b11 = BBE_MULNX16CPACKQ(b11, T64_16_11);
    b20 = BBE_MULNX16CPACKQ(b20, T64_16_20);
    b21 = BBE_MULNX16CPACKQ(b21, T64_16_21);
    b30 = BBE_MULNX16CPACKQ(b30, T64_16_30);
    b31 = BBE_MULNX16CPACKQ(b31, T64_16_31);
    ...
    b10 = BBE_MULNX16CPACKQ(b10, T16_4_10);
    b11 = BBE_MULNX16CPACKQ(b11, T16_4_11);
    b20 = BBE_MULNX16CPACKQ(b20, T16_4_20);
    b21 = BBE_MULNX16CPACKQ(b21, T16_4_21);
    b30 = BBE_MULNX16CPACKQ(b30, T16_4_30);
    b31 = BBE_MULNX16CPACKQ(b31, T16_4_31);
