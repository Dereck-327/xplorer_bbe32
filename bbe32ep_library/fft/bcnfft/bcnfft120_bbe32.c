...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcnfft120,( void * restrict pScr,
...
void bcnfft120 ( void * restrict pScr, complex_fract16 * restrict _y, complex_fract16 * restrict _x, int L )
{
  ...
  for (l = 0; l<L; l++)
  {
    ...
    x1 = BBE_MULNX16CPACKQ(x1, tw120_30_0);
    x2 = BBE_MULNX16CPACKQ(x2, tw120_30_1);
    x3 = BBE_MULNX16CPACKQ(x3, tw120_30_2);

    x5 = BBE_MULNX16CPACKQ(x5, tw120_30_3);
    x6 = BBE_MULNX16CPACKQ(x6, tw120_30_4);
    x7 = BBE_MULNX16CPACKQ(x7, tw120_30_5);

    x9 = BBE_MULNX16CPACKQ(x9, tw120_30_6);
    x10 = BBE_MULNX16CPACKQ(x10, tw120_30_7);
    x11 = BBE_MULNX16CPACKQ(x11, tw120_30_8);

    x13 = BBE_MULNX16CPACKQ(x13, tw120_30_9);
    x14 = BBE_MULNX16CPACKQ(x14, tw120_30_10);
    x15 = BBE_MULNX16CPACKQ(x15, tw120_30_11);
  ...
  for (l = 0; l<L; l++)
  {
    ...
    x3 = BBE_MULNX16CPACKQ(x3, tw3);
    x5 = BBE_MULNX16CPACKQ(x5, tw3);
    ...
    x0 = y0;
    x1 = BBE_MULNX16CPACKQ(y5, tw30_5_0);
    x2 = BBE_MULNX16CPACKQ(y1, tw30_5_1);
    x3 = BBE_MULNX16CPACKQ(y3, tw30_5_2);
    x4 = BBE_MULNX16CPACKQ(y2, tw30_5_3);
    x5 = BBE_MULNX16CPACKQ(y4, tw30_5_4);
    Y0_va = BBE_MOVUVR(x0);
    Y1_va = BBE_MOVUVR(x2);
  ...
  for (l = 0; l<L; l++)
  {
    ...
    tw5_0 = BBE_MOVVA16C(0xc322259e);
    tw5_1 = BBE_MOVVA16C(0x0000478e);
    tw5_2 = BBE_MOVVA16C(0xc322da62);
    {
      xb_vecNx16 tmpc;
