...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcinfft60,( void * restrict pScr,
...
void bcinfft60 ( void * restrict pScr, complex_fract16 * restrict y, complex_fract16 * restrict x, int L )
{
...

  {
    ...
    xb_vecNx16 r5tw1 = BBE_MOVVA16C(0x3cdeda62); // -0.29388 + j*0.47552
    xb_vecNx16 r5tw2 = BBE_MOVVA16C(0x0000478e); //  0.55902
    xb_vecNx16 r5tw3 = BBE_MOVVA16C(0x3cde25de); //  0.29388 + j*0.47552
