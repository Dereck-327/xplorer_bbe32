...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcnfft36,( void * restrict pScr,
...
void bcnfft36 ( void * restrict pScr, complex_fract16 * restrict y, complex_fract16 * restrict x, int L )
{
  ...
  //  X1 = (xb_vecNx16*)(x+2*BBE_SIMD_WIDTH);
  //----------------------------------------------------------------------------
  ...
  for (l = 0; l<L - 1; l++)
  {
    ...
    y1 = BBE_MULNX16CPACKQ(y1, tw36_9_0);
    y2 = BBE_MULNX16CPACKQ(y2, tw36_9_1);
    y3 = BBE_MULNX16CPACKQ(y3, tw36_9_2);

    y5 = BBE_MULNX16CPACKQ(y5, tw36_9_3);
    y6 = BBE_MULNX16CPACKQ(y6, tw36_9_4);
    y7 = BBE_MULNX16CPACKQ(y7, tw36_9_5);
  ...
  for (l = 0; l<L - 1; l++)
  {
    ...
    y1 = BBE_MULNX16CPACKQ(y1, tw9_3_0);
    y2 = BBE_MULNX16CPACKQ(y2, tw9_3_1);

    y4 = BBE_MULNX16CPACKQ(y4, tw9_3_2);
    y5 = BBE_MULNX16CPACKQ(y5, tw9_3_3);
