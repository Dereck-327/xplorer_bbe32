...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcinfft108,( void * restrict pScr,
...
void bcinfft108 ( void * restrict pScr, complex_fract16 * restrict y, complex_fract16 * restrict x, int L )
{
...

  {
    ...
    for ( l=0; l<L; l++ )
    {
      ...
      b01 = BBE_MULNX16JPACKQ( b01, tw1 );
      b02 = BBE_MULNX16JPACKQ( b02, tw2 );
      b03 = BBE_MULNX16JPACKQ( b03, tw3 );
      ...
      b11 = BBE_MULNX16JPACKQ( b11, tw4 );
      b12 = BBE_MULNX16JPACKQ( b12, tw5 );
      b13 = BBE_MULNX16JPACKQ( b13, tw6 );
      ...
      b21 = BBE_MULNX16JPACKQ( b21, tw7 );
      b22 = BBE_MULNX16JPACKQ( b22, tw8 );
      b23 = BBE_MULNX16JPACKQ( b23, tw9 );
      ...
      b31 = BBE_MULNX16JPACKQ( b31, tw10 );
      b32 = BBE_MULNX16JPACKQ( b32, tw11 );
      b33 = BBE_MULNX16JPACKQ( b33, tw12 );
...

  {
    ...
    for ( l=0; l<L; l++ )
    {
      ...
      t0 = BBE_MULNX16JPACKQ( a01, r3tw );
      t1 = BBE_MULNX16JPACKQ( a02, r3tw );
      ...
      t0 = BBE_MULNX16JPACKQ( a11, r3tw );
      t1 = BBE_MULNX16JPACKQ( a12, r3tw );
      ...
      b11 = BBE_MULNX16JPACKQ( b11, tw3 );
      b12 = BBE_MULNX16JPACKQ( b12, tw4 );
      ...
      t0 = BBE_MULNX16JPACKQ( a21, r3tw );
      t1 = BBE_MULNX16JPACKQ( a22, r3tw );
      ...
      b21 = BBE_MULNX16JPACKQ( b21, tw5 );
      b22 = BBE_MULNX16JPACKQ( b22, tw6 );
      ...
      t0 = BBE_MULNX16JPACKQ( a31, r3tw );
      t1 = BBE_MULNX16JPACKQ( a32, r3tw );
      ...
      b31 = BBE_MULNX16JPACKQ( b31, tw7 );
      b32 = BBE_MULNX16JPACKQ( b32, tw8 );
      ...
      t0 = BBE_MULNX16JPACKQ( a41, r3tw );
      t1 = BBE_MULNX16JPACKQ( a42, r3tw );
      ...
      b41 = BBE_MULNX16JPACKQ( b41, tw9  );
      b42 = BBE_MULNX16JPACKQ( b42, tw10 );
...

  {
    ...
    for ( l=0; l<L; l++ )
    {
      ...
      b21 = BBE_MULNX16JPACKQ( b21, tw1 );
      b22 = BBE_MULNX16JPACKQ( b22, tw2 );
      ...
      b31 = BBE_MULNX16JPACKQ( b31, tw1 );
      b32 = BBE_MULNX16JPACKQ( b32, tw2 );
      ...
      b41 = BBE_MULNX16JPACKQ( b41, tw3 );
      b42 = BBE_MULNX16JPACKQ( b42, tw4 );
      ...
      t0 = BBE_MULNX16JPACKQ( a51, r3tw );
      t1 = BBE_MULNX16JPACKQ( a52, r3tw );
      ...
      b51 = BBE_MULNX16JPACKQ( b51, tw3 );
      b52 = BBE_MULNX16JPACKQ( b52, tw4 );
