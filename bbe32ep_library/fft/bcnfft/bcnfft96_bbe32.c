...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcnfft96,( void * restrict pScr,
...
void bcnfft96 ( void * restrict pScr, complex_fract16 * restrict y, complex_fract16 * restrict x, int L )
{
  ...
  for (l = 0; l<L; l++)
  {
    ...
    y1 = BBE_MULNX16CPACKQ(y1, tw96_24_0);
    y2 = BBE_MULNX16CPACKQ(y2, tw96_24_1);
    y3 = BBE_MULNX16CPACKQ(y3, tw96_24_2);

    y5 = BBE_MULNX16CPACKQ(y5, tw96_24_3);
    y6 = BBE_MULNX16CPACKQ(y6, tw96_24_4);
    y7 = BBE_MULNX16CPACKQ(y7, tw96_24_5);

    y9 = BBE_MULNX16CPACKQ(y9, tw96_24_6);
    y10 = BBE_MULNX16CPACKQ(y10, tw96_24_7);
    y11 = BBE_MULNX16CPACKQ(y11, tw96_24_8);
  ...
  for (l = 0; l<L; l++)
  {
    ...
    y5 = BBE_MULNX16CPACKQ(y5, tw24_6_3);
    y6 = BBE_MULNX16CPACKQ(y6, tw24_6_4);
    y7 = BBE_MULNX16CPACKQ(y7, tw24_6_5);

    y9 = BBE_MULNX16CPACKQ(y9, tw24_6_6);
    y10 = BBE_MULNX16CPACKQ(y10, tw24_6_7);
    y11 = BBE_MULNX16CPACKQ(y11, tw24_6_8);
  ...
  for (l = 0; l<L; l++)
  {
    ...
    x8 = BBE_MULNX16CPACKQ(x8, tw3);
    x10 = BBE_MULNX16CPACKQ(x10, tw3);
    ...
    x9 = BBE_MULNX16CPACKQ(x9, tw3);
    x11 = BBE_MULNX16CPACKQ(x11, tw3);
