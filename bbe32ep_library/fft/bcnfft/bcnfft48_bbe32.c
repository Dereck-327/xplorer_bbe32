...
#if !(HAVE_FFT && 1)
DISCARD_FUN(void, bcnfft48,( void * restrict pScr,
...
void bcnfft48 ( void * restrict pScr, complex_fract16 * restrict y, complex_fract16 * restrict x, int L )
{
  ...
  xb_vecNx16 x4, x5=0, x6, x7=0, y4, y5, y6, y7;
  ...
  for (l = 0; l < L ; l++)
  {
    ...
    y1 = BBE_MULNX16CPACKQ(y1, tw48_12_0);
    y2 = BBE_MULNX16CPACKQ(y2, tw48_12_1);
    y3 = BBE_MULNX16CPACKQ(y3, tw48_12_2);

    y5 = BBE_MULNX16CPACKQ(y5, tw48_12_3);
    y6 = BBE_MULNX16CPACKQ(y6, tw48_12_4);
    y7 = BBE_MULNX16CPACKQ(y7, tw48_12_5);
  ...
  for (l = 0; l<L; l++)
  {
        ...
        y1 = BBE_MULNX16CPACKQ(y1, tw12_3_0);
        y2 = BBE_MULNX16CPACKQ(y2, tw12_3_1);
        y3 = BBE_MULNX16CPACKQ(y3, tw12_3_2);

        y5 = BBE_MULNX16CPACKQ(y5, tw12_3_3);
        y6 = BBE_MULNX16CPACKQ(y6, tw12_3_4);
        y7 = BBE_MULNX16CPACKQ(y7, tw12_3_5);
