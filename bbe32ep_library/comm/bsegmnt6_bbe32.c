...
void bsegmnt6 ( int16_t * restrict s, const uint8_t* b, int N )
{
    ...
    static const uint16_t ALIGN(32) tbl[3 * 16] = {
        4, 10, 0, 6, 12, 2, 8, 14, 4, 10, 0, 6, 12, 2, 8, 14,  //rsh0
        16, 16, 12, 16, 16, 14, 16, 16, 16, 16, 12, 16, 16, 14, 16, 16,  //rsh1
        63 << 0, 63 << 6, 63 >> 4, 63 << 2, 63 << 8, 63 >> 2, 63 << 4, 63 << 10, 63 << 0, 63 << 6, 63 >> 4, 63 << 2, 63 << 8, 63 >> 2, 63 << 4, 63 << 10
    };
    static const int32_t unsq[2] =
    { 0x9292,//0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 4, 5, 5, 5,
      0xA524 //0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 4, 5, 5,
    };
    vboolN unsqueeze;
    vselN rep0, rep1;
    vsaN  rsh0, rsh1;
    int i;
    xb_vecNx16  b0, r0, r1, z0, c4;
    xb_vecNx40  w0, w1;
    valign balign;
    ...
    {
        BBE_LAVNX16_XP(b0, balign, B, 12);
        r0 = BBE_SHFLNX16(b0, rep0);
        r0 = BBE_ANDNX16(r0, z0);
        r1 = BBE_SHFLNX16(b0, rep1);
        w0 = BBE_MULUUNX16(r0, c4);
