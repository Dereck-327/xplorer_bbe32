                  ...
                  int N )
{
    ...
    7 x1x1x0
    */
    static const int16_t ALIGN(32) iq[32] =
    {
        16, 0, 4, 20,   // -> 1,3,5,7
        20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, // >7
        21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, // <-7
        21, 5, 1, 17    // -> -7,-5,-3,-1
    };
    int n;
    vselN sel0, sel1;
    xb_vecNx16 tbl0, tbl1, tbl2, tbl3;
    xb_vecNx16 X0, X1;
    ...
    tbl0 = BBE_LVNX16_I((const xb_vecNx16*)iq, 0);
    tbl1 = BBE_LVNX16_I((const xb_vecNx16*)iq, 2 * BBE_SIMD_WIDTH);
    tbl2 = BBE_ADDNX16(tbl0, tbl0);
    tbl3 = BBE_ADDNX16(tbl1, tbl1);
    ...
    for (n = 0; n < (N >> (LOG2_BBE_SIMD_WIDTH)); n++)
    {
        ...
        sel0 = BBE_MOVVSELNX16(X0, 11);
        sel1 = BBE_MOVVSELNX16(X1, 11);
        X0 = BBE_SELNX16(tbl1, tbl0, sel0);
        X1 = BBE_SELNX16(tbl3, tbl2, sel1);
