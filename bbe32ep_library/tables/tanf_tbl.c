...
const float32_t tanf_maxval=9099.f; /* domain ranges - NaN outside */
...
/*
    ...
    p=p(1:2:end); p(end)=[];
*/
const union ufloat32uint32 ALIGN(32) polytanf_tbl[POLYTAN_LEN + ( -POLYTAN_LEN & ((BBE_SIMD_WIDTH/2)-1) )]=
#if POLYTAN_LEN==7
    {
...
const union ufloat32uint32 ALIGN(32) fstpolytanf_tbl[POLYTAN_LEN + (-POLYTAN_LEN & ((BBE_SIMD_WIDTH / 2) - 1))] =
#if FSTPOLYTAN_LEN==6
{
  { 0x3c163d95 }, /* 0.009169955908763*/
  { 0x3b62bffc }, /* 0.003459929495694*/
  { 0x3cc6939a }, /* 0.024240303903646*/
  { 0x3d5af2df }, /* 0.053454277328885*/
  { 0x3e089623 }, /* 0.133385223648891*/
  { 0x3eaaaa6a }  /* 0.333331400753200*/
};
#else 
#error unsupported
#endif
...
/*
    ...
    p=p(1:2:end); p(end)=[];
*/
const union ufloat32uint32 ALIGN(32) polyinvcosf_tbl[]=
{
