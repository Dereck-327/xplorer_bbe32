...
/* pi/2 represented as a sum of exacly represented numbers.
   Derived from hex value of pi: 3.243F6A8885A308D313198A2E037073
*/
const union ufloat32uint32 ALIGN(32) pi2fc[] =
{
    {0x3fc90fdb}, /*  13176795*2^(-22-1) */
    {0xb33bbd2e}, /* -12303662*2^(-47-1) */
    {0xa6f72ced}, /* -16198893*2^(-72-1) */
};
