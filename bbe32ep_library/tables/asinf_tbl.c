...
*/
const union ufloat32uint32 ALIGN(32) asinftbl[5]=
{
...
#elif ASINF_ALG==1 /* for 1 ULP variant */
/*
    polynomial coefficients for asin(x)/x-1 in range 0...0.55
    derived by MATLAB code:
    x=(0:pow2(1,-16):0.55); x(1)=[]; x=[-x(end:-1:1) x];
    z=asin(x)./x-1;
    p=polyfit(x,z,11);
    p=p(2:2:end);
*/
const union ufloat32uint32 ALIGN_PDX_4M asinftbl[5]=
{
    {0x3d43c8d5},   /* 0.0477989489 */
    {0x3caa2a19},   /* 0.0207720259 */
    {0x3d3d2cee},   /* 0.0461854260 */
    {0x3d996107},   /* 0.0748920995 */
    {0x3e2aab60}    /* 0.1666693628 */
};
#else
