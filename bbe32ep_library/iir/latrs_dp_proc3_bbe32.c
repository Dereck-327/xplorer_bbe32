...
void latrs_dp_proc3( int16_t * restrict r,
                     int16_t * restrict d,
               const int16_t *          x,
               const int16_t *          coef,
                     int16_t            gain,
...
{ 
  xb_vecNx16 d0, d1;
  xb_vecNx16 X, Y, g, Coef0, Coef1, Coef2;
  xb_vecNx16 D_l0, D_h0, D_l1, D_h1, D_l2, D_h2;
  int32_t Coef12;
  ...
  Coef12 = (((int32_t)(-coef[1]))<<16);
  Coef12 |= (uint16_t)(-coef[2]);
  ...
  for ( l=0; l<(L>>LOG2_BBE_SIMD_WIDTH); l++ )
  {
    ...
    for ( j=0; j<N; j++ )
    {
      ...
      BBE_MULANX16PR(T, D_h1, D_h2, Coef12);
      BBE_MULANX16PR(T, D_h1, D_h2, Coef12);
      
      Z = BBE_MULUSRNX16(D_l2, Coef2, rnd15);
      BBE_MULUSANX16(Z,  D_l1, Coef1);
      Z = BBE_SRAINX40(Z, 15);
