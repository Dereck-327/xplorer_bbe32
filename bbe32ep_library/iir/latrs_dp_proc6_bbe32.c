...
void latrs_dp_proc6( int16_t * restrict r,
                     int16_t * restrict d,
               const int16_t *          x,
               const int16_t *          coef,
                     int16_t            gain,
                     int N, int L )
{
  ...
  xb_vecNx16 X, Y, g;
  xb_vecNx16 Coef0, Coef1, Coef2, Coef3, Coef4, Coef5;
  xb_vecNx16 D_l0, D_l1, D_l2, D_l3, D_l4, D_l5;
  xb_vecNx16 D_h0, D_h1, D_h2, D_h3, D_h4, D_h5;
  int32_t Coef45;
  ...
  Coef45 = (((int32_t)(-coef[4]))<<16);
  Coef45 |= (uint16_t)(-coef[5]);
  ...
  for ( l=0; l<(L>>LOG2_BBE_SIMD_WIDTH); l++ )
  {
    ...
    _D = (      xb_vecNx16 *)(d + 2*6*BBE_SIMD_WIDTH*l);
    _R = (      xb_vecNx16 *)(r + 1*1*BBE_SIMD_WIDTH*l);  

    BBE_LVNX16_IP(D_l5, _D, sz_i16*BBE_SIMD_WIDTH); 
    BBE_LVNX16_IP(D_h5, _D, sz_i16*BBE_SIMD_WIDTH);
     
    D_l4 = BBE_LVNX16_I(_D, sz_i16*0*BBE_SIMD_WIDTH); 
    D_h4 = BBE_LVNX16_I(_D, sz_i16*1*BBE_SIMD_WIDTH);
    ...
    for ( j=0; j<N; j++ )
    {
      ...
      BBE_MULANX16PR(T, D_h4, D_h5, Coef45);
      BBE_MULANX16PR(T, D_h4, D_h5, Coef45);
      ...
      D_l3 = BBE_LVNX16_I(_D, sz_i16*2*BBE_SIMD_WIDTH); 
      D_h3 = BBE_LVNX16_I(_D, sz_i16*3*BBE_SIMD_WIDTH);
      ...
      BBE_SVNX16_XP(D_h1, _D, -(int)sz_i16*7*BBE_SIMD_WIDTH);
    }
    
    BBE_SVNX16_I(D_l5, _D, -(int)sz_i16*2*BBE_SIMD_WIDTH);
    BBE_SVNX16_I(D_h5, _D, -(int)sz_i16*1*BBE_SIMD_WIDTH);
  }
} // latr_dp_proc6()
