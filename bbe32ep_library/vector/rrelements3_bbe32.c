...
{
    int n;
    static const int16_t ALIGN(32) SEL[BBE_SIMD_WIDTH] = { 9, 10, 12, 13, 15, 16, 18, 19, 21, 22, 24, 25, 27, 28, 30, 31 };
    ...
    for (n = 0; n<(N >> (LOG2_BBE_SIMD_WIDTH + 1)); n++)
    {
        ...
        t0 = BBE_SELNX16I(x1, x0, BBE_SELI_EXTRACT_2_OF_3_OFF_1);
        BBE_SVNX16_IP(t0, pY, 2 * BBE_SIMD_WIDTH);
        t1 = BBE_SELNX16(x2, x1, sel0);
