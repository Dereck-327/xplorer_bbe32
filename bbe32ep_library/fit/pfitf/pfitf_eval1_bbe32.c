...
#else
{
    ...
    aY=BBE_ZALIGN();
    BBE_LAVN_2XF32_XP(pp,aP,pP,2*sizeof(float32_t));
...
#endif
#else
DISCARD_FUN(void,pfitf_eval1,(float32_t * yi,const float32_t * xi,const float32_t * poly,int P))
#endif
