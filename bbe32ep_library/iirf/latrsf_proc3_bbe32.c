...
---------------------------------------------------------------------------*/
void latrsf_process3( latrsf_t  *          latrs,
                      ...
                      int                  N )
{
    ...
    {
        DL2 = BBE_LVN_2XF32_I(delLine, 0*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL1 = BBE_LVN_2XF32_I(delLine, 1*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL0 = BBE_LVN_2XF32_I(delLine, 2*BBE_SIMD_WIDTH/2*sizeof(float32_t));
