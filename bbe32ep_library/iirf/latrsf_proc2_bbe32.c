...
---------------------------------------------------------------------------*/
void latrsf_process2( latrsf_t  *          latrs,
                      ...
                      int                  N )
{
    ...
    xb_vecN_2xf32 Xin,Rout,DL0,DL1,CF0,CF1;
    ...
    {
        DL0 = BBE_LVN_2XF32_I(delLine, 0);
        DL1 = BBE_LVN_2XF32_I(delLine, BBE_SIMD_WIDTH/2*sizeof(float32_t));
