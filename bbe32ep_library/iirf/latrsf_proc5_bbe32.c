...
---------------------------------------------------------------------------*/
void latrsf_process5( latrsf_t  *          latrs,
                      ...
                      int                  N )
{
    ...
    {
        DL4 = BBE_LVN_2XF32_I(delLine, 0*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL3 = BBE_LVN_2XF32_I(delLine, 1*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL2 = BBE_LVN_2XF32_I(delLine, 2*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL1 = BBE_LVN_2XF32_I(delLine, 3*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL0 = BBE_LVN_2XF32_I(delLine, 4*BBE_SIMD_WIDTH/2*sizeof(float32_t));
