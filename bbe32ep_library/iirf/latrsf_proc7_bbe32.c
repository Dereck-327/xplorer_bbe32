...
---------------------------------------------------------------------------*/
void latrsf_process7( latrsf_t  *          latrs,
                      ...
                      int                  N )
{
    ...
    {
        DL6 = BBE_LVN_2XF32_I(delLine, 0*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL5 = BBE_LVN_2XF32_I(delLine, 1*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL4 = BBE_LVN_2XF32_I(delLine, 2*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL3 = BBE_LVN_2XF32_I(delLine, 3*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL2 = BBE_LVN_2XF32_I(delLine, 4*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL1 = BBE_LVN_2XF32_I(delLine, 5*BBE_SIMD_WIDTH/2*sizeof(float32_t));
        DL0 = BBE_LVN_2XF32_I(delLine, 6*BBE_SIMD_WIDTH/2*sizeof(float32_t));
