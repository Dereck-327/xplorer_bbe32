...
/*  
	...
	Integrit, 2006-2016
*/
#ifndef CMATMULNXMN_COMMON__
#define CMATMULNXMN_COMMON__
...
void cmatmulnxmn_tail(void * pScr, complex_fract16 * restrict z, const complex_fract16 * restrict x, const complex_fract16 * restrict y, int N, int M, int Q);
