...
/* pi/4 represented as a truncated sum of exacly represented numbers.
   Derived from hex value of pi: 3.243F6A8885A308D313198A2E037073
*/
externC const union ufloat64uint64 ALIGN(32) pi4fc[];

/* pi/2 represented as a truncated sum of exacly represented numbers.
   Derived from hex value of pi: 3.243F6A8885A308D313198A2E037073
*/
externC const union ufloat32uint32 ALIGN(32)  pi2fc[];
...
*/
externC const union ufloat32uint32 ALIGN(32)  polysinf_tbl[];
...
/* 
   ...
   p=polyfit(x,y,6); p=p(1:2:end); p(end)=[];
*/
externC const union ufloat32uint32 ALIGN(32)  polycosf_tbl[];
